...
| `coverage_options` | `null | any[]` | Available member-scoped coverage options for the plan. |
...
| `metadata` | `null | Record<string, any>` | Set of key-value pairs that you can attach to an object. |
...
| `coverage_options` | `null | any[]` | Coverage options available for this plan, organized by scope and input type. |
