...
import type {
  Dependent,
  DependentCreateData,
  DependentRemoveMatch,
} from '../KotaTypes'

// TODO: needs Entity superclass
class DependentEntity extends KotaEntityBase<Dependent> {

  constructor(client: KotaSDK, entopts: any) {
    super(client, entopts)
    this.name = 'dependent'
    this.name_ = 'dependent'
    this.Name = 'Dependent'
  }


  make(this: DependentEntity) {
    return new DependentEntity(this._client, this.entopts())
  }
  ...
  async create(this: any, reqdata?: DependentCreateData, ctrl?: Control): Promise<DependentEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Dependent> return stays clean under strict null checks.
  ...
  async remove(
    this: any, reqmatch?: DependentRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<DependentEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
