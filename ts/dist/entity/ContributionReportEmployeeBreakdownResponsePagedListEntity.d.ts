...
declare class ContributionReportEmployeeBreakdownResponsePagedListEntity extends KotaEntityBase<ContributionReportEmployeeBreakdownResponsePagedList> {
    ...
    list(this: any, reqmatch?: ContributionReportEmployeeBreakdownResponsePagedListListMatch, ctrl?: Control): Promise<ContributionReportEmployeeBreakdownResponsePagedList[]>;
}
