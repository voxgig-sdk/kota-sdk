...
(0, node_test_1.describe)('CreateSessionTokenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'create_session_token.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != create_session_token_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/create_session_token/CreateSessionTokenTestData.json');
    ...
    let idmap = transform(['create_session_token01', 'create_session_token02', 'create_session_token03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['KOTA_TEST_CREATE_SESSION_TOKEN_ENTID'];
...
//# sourceMappingURL=CreateSessionTokenEntity.test.js.map