...
(0, node_test_1.describe)('EnrolmentIntentRequirementResponsePagedListEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'enrolment_intent_requirement_response_paged_list.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/enrolment_intent_requirement_response_paged_list/EnrolmentIntentRequirementResponsePagedListTestData.json');
    ...
    let idmap = transform(['enrolment_intent_requirement_response_paged_list01', 'enrolment_intent_requirement_response_paged_list02', 'enrolment_intent_requirement_response_paged_list03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['KOTA_TEST_ENROLMENT_INTENT_REQUIREMENT_RESPONSE_PAGED_LIST_ENTID'];
...
//# sourceMappingURL=EnrolmentIntentRequirementResponsePagedListEntity.test.js.map