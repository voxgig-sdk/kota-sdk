...
(0, node_test_1.describe)('EnrolmentIntentRequirementResponsePagedListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-enrolment_intent_requirement_response_paged_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-enrolment_intent_requirement_response_paged_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["enrolment_intent_requirement_response_paged_list01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['KOTA_TEST_ENROLMENT_INTENT_REQUIREMENT_RESPONSE_PAGED_LIST_ENTID'];
...
//# sourceMappingURL=EnrolmentIntentRequirementResponsePagedListDirect.test.js.map