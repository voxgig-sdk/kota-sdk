...
(0, node_test_1.describe)('ProviderDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-provider', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-provider', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-provider', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-provider', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['KOTA_TEST_PROVIDER_ENTID'];
...
//# sourceMappingURL=ProviderDirect.test.js.map