...
(0, node_test_1.describe)('EmployeeHealthInsurancePolicyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-employee_health_insurance_policy', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-employee_health_insurance_policy', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['KOTA_TEST_EMPLOYEE_HEALTH_INSURANCE_POLICY_ENTID'];
...
//# sourceMappingURL=EmployeeHealthInsurancePolicyDirect.test.js.map