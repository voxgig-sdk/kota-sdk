...
(0, node_test_1.describe)('PolicyImportIntentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-policy_import_intent', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-policy_import_intent', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-policy_import_intent', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-policy_import_intent', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['KOTA_TEST_POLICY_IMPORT_INTENT_ENTID'];
...
//# sourceMappingURL=PolicyImportIntentDirect.test.js.map