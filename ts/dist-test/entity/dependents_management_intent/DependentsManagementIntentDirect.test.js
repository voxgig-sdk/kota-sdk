...
(0, node_test_1.describe)('DependentsManagementIntentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-dependents_management_intent', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-dependents_management_intent', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['KOTA_TEST_DEPENDENTS_MANAGEMENT_INTENT_ENTID'];
...
//# sourceMappingURL=DependentsManagementIntentDirect.test.js.map