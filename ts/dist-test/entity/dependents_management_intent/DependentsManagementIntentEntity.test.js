...
(0, node_test_1.describe)('DependentsManagementIntentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'dependents_management_intent.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/dependents_management_intent/DependentsManagementIntentTestData.json');
    ...
    let idmap = transform(['dependents_management_intent01', 'dependents_management_intent02', 'dependents_management_intent03', 'enrolment_intent01', 'enrolment_intent02', 'enrolment_intent03', 'policy01', 'policy02', 'policy03', 'policy_amendment_intent01', 'policy_amendment_intent02', 'policy_amendment_intent03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DependentsManagementIntentEntity.test.js.map