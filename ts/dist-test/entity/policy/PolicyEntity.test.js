...
(0, node_test_1.describe)('PolicyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'policy.' + op, live))
                return;
        }
        ...
        let policy_ref01_data = Object.values(setup.data.existing.policy)[0];
        // LIST
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/policy/PolicyTestData.json');
    ...
    let idmap = transform(['policy01', 'policy02', 'policy03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=PolicyEntity.test.js.map