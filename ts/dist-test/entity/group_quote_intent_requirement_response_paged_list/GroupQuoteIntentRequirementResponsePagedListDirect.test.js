...
(0, node_test_1.describe)('GroupQuoteIntentRequirementResponsePagedListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-group_quote_intent_requirement_response_paged_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-group_quote_intent_requirement_response_paged_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["group_quote_intent_requirement_response_paged_list01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['KOTA_TEST_GROUP_QUOTE_INTENT_REQUIREMENT_RESPONSE_PAGED_LIST_ENTID'];
...
//# sourceMappingURL=GroupQuoteIntentRequirementResponsePagedListDirect.test.js.map