...
(0, node_test_1.describe)('GroupQuoteIntentRequirementResponsePagedListEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'group_quote_intent_requirement_response_paged_list.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/group_quote_intent_requirement_response_paged_list/GroupQuoteIntentRequirementResponsePagedListTestData.json');
    ...
    let idmap = transform(['group_quote_intent_requirement_response_paged_list01', 'group_quote_intent_requirement_response_paged_list02', 'group_quote_intent_requirement_response_paged_list03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=GroupQuoteIntentRequirementResponsePagedListEntity.test.js.map