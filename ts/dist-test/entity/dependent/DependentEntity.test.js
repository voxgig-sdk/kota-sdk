...
(0, node_test_1.describe)('DependentEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.Dependent();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.KOTA_TEST_LIVE;
        for (const op of ['create', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'dependent.' + op, live))
                return;
        }
        ...
        await dependent_ref01_ent.remove(dependent_ref01_match_rm0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/dependent/DependentTestData.json');
    ...
    let idmap = transform(['dependent01', 'dependent02', 'dependent03', 'dependents_management_intent01', 'dependents_management_intent02', 'dependents_management_intent03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['KOTA_TEST_DEPENDENT_ENTID'];
    ...
    idmap = env['KOTA_TEST_DEPENDENT_ENTID'];
...
//# sourceMappingURL=DependentEntity.test.js.map