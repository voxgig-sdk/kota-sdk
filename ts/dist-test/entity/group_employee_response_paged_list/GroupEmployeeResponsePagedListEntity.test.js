...
(0, node_test_1.describe)('GroupEmployeeResponsePagedListEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let group_employee_response_paged_list_ref01_data = Object.values(setup.data.existing.group_employee_response_paged_list)[0];
        // LIST
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/group_employee_response_paged_list/GroupEmployeeResponsePagedListTestData.json');
    ...
    let idmap = transform(['group_employee_response_paged_list01', 'group_employee_response_paged_list02', 'group_employee_response_paged_list03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=GroupEmployeeResponsePagedListEntity.test.js.map