...
(0, node_test_1.describe)('GroupPolicyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'group_policy.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(group_policy_ref01_data_dt0.id === group_policy_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/group_policy/GroupPolicyTestData.json');
    ...
    let idmap = transform(['group_policy01', 'group_policy02', 'group_policy03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['KOTA_TEST_GROUP_POLICY_ENTID'];
...
//# sourceMappingURL=GroupPolicyEntity.test.js.map