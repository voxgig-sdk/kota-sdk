...
(0, node_test_1.describe)('ContributionReportDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-contribution_report', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-contribution_report', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-contribution_report', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-contribution_report', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['KOTA_TEST_CONTRIBUTION_REPORT_ENTID'];
...
//# sourceMappingURL=ContributionReportDirect.test.js.map