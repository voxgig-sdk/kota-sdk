...
(0, node_test_1.describe)('ContributionReportEmployeeBreakdownResponsePagedListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-contribution_report_employee_breakdown_response_paged_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-contribution_report_employee_breakdown_response_paged_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["contribution_report_employee_breakdown_response_paged_list01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['KOTA_TEST_CONTRIBUTION_REPORT_EMPLOYEE_BREAKDOWN_RESPONSE_PAGED_LIST_ENTID'];
...
//# sourceMappingURL=ContributionReportEmployeeBreakdownResponsePagedListDirect.test.js.map