...
(0, node_test_1.describe)('ContributionReportEmployeeBreakdownResponsePagedListEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'contribution_report_employee_breakdown_response_paged_list.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/contribution_report_employee_breakdown_response_paged_list/ContributionReportEmployeeBreakdownResponsePagedListTestData.json');
    ...
    let idmap = transform(['contribution_report_employee_breakdown_response_paged_list01', 'contribution_report_employee_breakdown_response_paged_list02', 'contribution_report_employee_breakdown_response_paged_list03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['KOTA_TEST_CONTRIBUTION_REPORT_EMPLOYEE_BREAKDOWN_RESPONSE_PAGED_LIST_ENTID'];
...
//# sourceMappingURL=ContributionReportEmployeeBreakdownResponsePagedListEntity.test.js.map