...
(0, node_test_1.describe)('AssociatedPersonDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-associated_person', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-associated_person', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-associated_person', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-associated_person', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['KOTA_TEST_ASSOCIATED_PERSON_ENTID'];
...
//# sourceMappingURL=AssociatedPersonDirect.test.js.map