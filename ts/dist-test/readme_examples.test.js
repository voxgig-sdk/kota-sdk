...
const TEST_SEED = { "entity": { "associated_person": { "test01": { "id": "test01" } }, "associated_person_eligibility_response_paged_list": { "test01": { "id": "test01" } }, "contribution_report": { "test01": { "id": "test01" } }, "contribution_report_employee_breakdown": { "test01": { "id": "test01" } }, "contribution_report_employee_breakdown_response_paged_list": { "test01": { "id": "test01" } }, "create_hosted_session_token": { "test01": { "id": "test01" } }, "create_session_token": { "test01": { "id": "test01" } }, "dependent": { "test01": { "id": "test01" } }, "dependents_management_intent": { "test01": { "id": "test01" } }, "eligibility_check": { "test01": { "id": "test01" } }, "employee": { "test01": { "id": "test01" } }, "employee_health_insurance_offer": { "test01": { "id": "test01" } }, "employee_health_insurance_offer_response_paged_list": { "test01": { "id": "test01" } }, "employee_health_insurance_policy": { "test01": { "id": "test01" } }, "employee_health_insurance_policy_response_paged_list": { "test01": { "id": "test01" } }, "employer": { "test01": { "id": "test01" } }, "employer_health_insurance_policy": { "test01": { "id": "test01" } }, "employer_health_insurance_policy_response_paged_list": { "test01": { "id": "test01" } }, "employer_health_insurance_quote": { "test01": { "id": "test01" } }, "employer_health_insurance_quote_response_paged_list": { "test01": { "id": "test01" } }, "enrolment_intent": { "test01": { "id": "test01" } }, "enrolment_intent_requirement_response_paged_list": { "test01": { "id": "test01" } }, "event": { "test01": { "id": "test01" } }, "group": { "test01": { "id": "test01" } }, "group_employee": { "test01": { "id": "test01" } }, "group_employee_response_paged_list": { "test01": { "id": "test01" } }, "group_policy": { "test01": { "id": "test01" } }, "group_policy_intent": { "test01": { "id": "test01" } }, "group_policy_intent_requirement_response_paged_list": { "test01": { "id": "test01" } }, "group_quote": { "test01": { "id": "test01" } }, "group_quote_intent": { "test01": { "id": "test01" } }, "group_quote_intent_requirement_response_paged_list": { "test01": { "id": "test01" } }, "plan": { "test01": { "id": "test01" } }, "policy": { "test01": { "id": "test01" } }, "policy_amendment_intent": { "test01": { "id": "test01" } }, "policy_import_intent": { "test01": { "id": "test01" } }, "provider": { "test01": { "id": "test01" } }, "replay": { "test01": { "id": "test01" } }, "webhook_endpoint": { "test01": { "id": "test01" } }, "webhook_endpoint_response_paged_list": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+KotaSDK\b/.test(code) ||
        /\bKotaSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+KotaSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/KotaSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
