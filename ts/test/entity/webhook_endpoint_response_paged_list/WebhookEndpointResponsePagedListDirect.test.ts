...
describe('WebhookEndpointResponsePagedListDirect', async () => {
  ...
  test('direct-list-webhook_endpoint_response_paged_list', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-webhook_endpoint_response_paged_list', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['KOTA_TEST_WEBHOOK_ENDPOINT_RESPONSE_PAGED_LIST_ENTID']
