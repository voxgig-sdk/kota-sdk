...
describe('ContributionReportEmployeeBreakdownDirect', async () => {
  ...
  test('direct-load-contribution_report_employee_breakdown', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-contribution_report_employee_breakdown', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['KOTA_TEST_CONTRIBUTION_REPORT_EMPLOYEE_BREAKDOWN_ENTID']
