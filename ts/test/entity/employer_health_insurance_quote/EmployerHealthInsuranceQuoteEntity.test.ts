...
describe('EmployerHealthInsuranceQuoteEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['load']) {
      if (maybeSkipControl(t, 'entityOp', 'employer_health_insurance_quote.' + op, live)) return
    }
...
function basicSetup(extra?: any) {
  ...
  const idmapEnvVal = process.env['KOTA_TEST_EMPLOYER_HEALTH_INSURANCE_QUOTE_ENTID']
