...
describe('EmployeeHealthInsurancePolicyDirect', async () => {
  ...
  test('direct-load-employee_health_insurance_policy', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-employee_health_insurance_policy', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['KOTA_TEST_EMPLOYEE_HEALTH_INSURANCE_POLICY_ENTID']
