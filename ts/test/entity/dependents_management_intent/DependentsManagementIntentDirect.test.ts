...
describe('DependentsManagementIntentDirect', async () => {
  ...
  test('direct-load-dependents_management_intent', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-dependents_management_intent', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['KOTA_TEST_DEPENDENTS_MANAGEMENT_INTENT_ENTID']
