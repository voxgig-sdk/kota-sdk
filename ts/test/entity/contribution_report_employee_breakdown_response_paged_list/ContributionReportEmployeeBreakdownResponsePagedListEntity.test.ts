...
describe('ContributionReportEmployeeBreakdownResponsePagedListEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (maybeSkipControl(t, 'entityOp', 'contribution_report_employee_breakdown_response_paged_list.' + op, live)) return
    }
    ...
    let contribution_report_employee_breakdown_response_paged_list_ref01_data = Object.values(setup.data.existing.contribution_report_employee_breakdown_response_paged_list)[0] as any
    ...
    const contribution_report_employee_breakdown_response_paged_list_ref01_match: any = {}
    ...
    const contribution_report_employee_breakdown_response_paged_list_ref01_list = (await contribution_report_employee_breakdown_response_paged_list_ref01_ent.list(contribution_report_employee_breakdown_response_paged_list_ref01_match)).map((e: any) => e.data())
