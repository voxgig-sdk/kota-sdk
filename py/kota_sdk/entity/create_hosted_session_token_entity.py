...
class CreateHostedSessionTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CreateHostedSessionTokenEntity(self._client, opts)
    ...
    def data_get(self) -> CreateHostedSessionToken:
    ...
    def match_get(self) -> CreateHostedSessionToken:
    ...
    def create(self, reqdata: CreateHostedSessionTokenCreateData, ctrl=None) -> CreateHostedSessionToken:
        utility = self._utility
