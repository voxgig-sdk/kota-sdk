...
from kota_sdk.kota_types import (
    ...
    GroupQuoteIntentRequirementResponsePagedListListMatch,
)
...
class GroupQuoteIntentRequirementResponsePagedListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GroupQuoteIntentRequirementResponsePagedListEntity(self._client, opts)
    ...
    def data_get(self) -> GroupQuoteIntentRequirementResponsePagedList:
    ...
    def match_get(self) -> GroupQuoteIntentRequirementResponsePagedList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GroupQuoteIntentRequirementResponsePagedList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GroupQuoteIntentRequirementResponsePagedList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
