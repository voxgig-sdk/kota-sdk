...
class EmployerHealthInsuranceQuoteEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmployerHealthInsuranceQuoteEntity(self._client, opts)
    ...
    def data_get(self) -> EmployerHealthInsuranceQuote:
    ...
    def match_get(self) -> EmployerHealthInsuranceQuote:
    ...
    def load(self, reqmatch=None, ctrl=None) -> EmployerHealthInsuranceQuote:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.EmployerHealthInsuranceQuote().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
