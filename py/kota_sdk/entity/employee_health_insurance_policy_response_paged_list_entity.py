...
class EmployeeHealthInsurancePolicyResponsePagedListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmployeeHealthInsurancePolicyResponsePagedListEntity(self._client, opts)
    ...
    def data_get(self) -> EmployeeHealthInsurancePolicyResponsePagedList:
    ...
    def match_get(self) -> EmployeeHealthInsurancePolicyResponsePagedList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EmployeeHealthInsurancePolicyResponsePagedList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EmployeeHealthInsurancePolicyResponsePagedList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
