...
from kota_sdk.kota_types import (
    ...
    WebhookEndpointResponsePagedListListMatch,
)
...
class WebhookEndpointResponsePagedListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WebhookEndpointResponsePagedListEntity(self._client, opts)
    ...
    def data_get(self) -> WebhookEndpointResponsePagedList:
    ...
    def match_get(self) -> WebhookEndpointResponsePagedList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[WebhookEndpointResponsePagedList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.WebhookEndpointResponsePagedList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
