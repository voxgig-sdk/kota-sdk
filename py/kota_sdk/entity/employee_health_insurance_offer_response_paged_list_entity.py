...
class EmployeeHealthInsuranceOfferResponsePagedListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmployeeHealthInsuranceOfferResponsePagedListEntity(self._client, opts)
    ...
    def data_get(self) -> EmployeeHealthInsuranceOfferResponsePagedList:
    ...
    def match_get(self) -> EmployeeHealthInsuranceOfferResponsePagedList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EmployeeHealthInsuranceOfferResponsePagedList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EmployeeHealthInsuranceOfferResponsePagedList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
