...
class ContributionReportEmployeeBreakdownEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ContributionReportEmployeeBreakdownEntity(self._client, opts)
    ...
    def data_get(self) -> ContributionReportEmployeeBreakdown:
    ...
    def match_get(self) -> ContributionReportEmployeeBreakdown:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ContributionReportEmployeeBreakdown:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ContributionReportEmployeeBreakdown().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
