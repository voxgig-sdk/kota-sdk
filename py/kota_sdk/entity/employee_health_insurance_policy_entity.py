...
class EmployeeHealthInsurancePolicyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmployeeHealthInsurancePolicyEntity(self._client, opts)
    ...
    def data_get(self) -> EmployeeHealthInsurancePolicy:
    ...
    def match_get(self) -> EmployeeHealthInsurancePolicy:
    ...
    def load(self, reqmatch=None, ctrl=None) -> EmployeeHealthInsurancePolicy:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.EmployeeHealthInsurancePolicy().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
