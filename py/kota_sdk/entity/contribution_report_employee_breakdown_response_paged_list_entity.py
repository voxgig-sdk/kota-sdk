...
from kota_sdk.kota_types import (
    ...
    ContributionReportEmployeeBreakdownResponsePagedListListMatch,
)
...
class ContributionReportEmployeeBreakdownResponsePagedListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ContributionReportEmployeeBreakdownResponsePagedListEntity(self._client, opts)
    ...
    def data_get(self) -> ContributionReportEmployeeBreakdownResponsePagedList:
    ...
    def match_get(self) -> ContributionReportEmployeeBreakdownResponsePagedList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ContributionReportEmployeeBreakdownResponsePagedList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ContributionReportEmployeeBreakdownResponsePagedList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
