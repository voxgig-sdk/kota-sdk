...
from kota_sdk.kota_types import (
    ...
    AssociatedPersonEligibilityResponsePagedListListMatch,
)
...
class AssociatedPersonEligibilityResponsePagedListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AssociatedPersonEligibilityResponsePagedListEntity(self._client, opts)
    ...
    def data_get(self) -> AssociatedPersonEligibilityResponsePagedList:
    ...
    def match_get(self) -> AssociatedPersonEligibilityResponsePagedList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AssociatedPersonEligibilityResponsePagedList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AssociatedPersonEligibilityResponsePagedList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
