...
from kota_sdk.kota_types import (
    EnrolmentIntent,
    EnrolmentIntentLoadMatch,
    EnrolmentIntentListMatch,
    EnrolmentIntentCreateData,
    EnrolmentIntentUpdateData,
)
...
class EnrolmentIntentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EnrolmentIntentEntity(self._client, opts)
    ...
    def data_get(self) -> EnrolmentIntent:
    ...
    def match_get(self) -> EnrolmentIntent:
    ...
    def load(self, reqmatch=None, ctrl=None) -> EnrolmentIntent:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.EnrolmentIntent().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EnrolmentIntent]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EnrolmentIntent().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: EnrolmentIntentCreateData, ctrl=None) -> EnrolmentIntent:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: EnrolmentIntentUpdateData, ctrl=None) -> EnrolmentIntent:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
