...
class DependentsManagementIntentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DependentsManagementIntentEntity(self._client, opts)
    ...
    def data_get(self) -> DependentsManagementIntent:
    ...
    def match_get(self) -> DependentsManagementIntent:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DependentsManagementIntent:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DependentsManagementIntent().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: DependentsManagementIntentCreateData, ctrl=None) -> DependentsManagementIntent:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
