...
from kota_sdk.kota_types import (
    ...
    GroupPolicyIntentRequirementResponsePagedListListMatch,
)
...
class GroupPolicyIntentRequirementResponsePagedListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GroupPolicyIntentRequirementResponsePagedListEntity(self._client, opts)
    ...
    def data_get(self) -> GroupPolicyIntentRequirementResponsePagedList:
    ...
    def match_get(self) -> GroupPolicyIntentRequirementResponsePagedList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GroupPolicyIntentRequirementResponsePagedList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GroupPolicyIntentRequirementResponsePagedList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
