...
from kota_sdk.kota_types import (
    ...
    EmployerHealthInsurancePolicyResponsePagedListListMatch,
)
...
class EmployerHealthInsurancePolicyResponsePagedListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmployerHealthInsurancePolicyResponsePagedListEntity(self._client, opts)
    ...
    def data_get(self) -> EmployerHealthInsurancePolicyResponsePagedList:
    ...
    def match_get(self) -> EmployerHealthInsurancePolicyResponsePagedList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EmployerHealthInsurancePolicyResponsePagedList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EmployerHealthInsurancePolicyResponsePagedList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
