...
from kota_sdk.kota_types import (
    ...
    GroupEmployeeResponsePagedListListMatch,
)
...
class GroupEmployeeResponsePagedListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GroupEmployeeResponsePagedListEntity(self._client, opts)
    ...
    def data_get(self) -> GroupEmployeeResponsePagedList:
    ...
    def match_get(self) -> GroupEmployeeResponsePagedList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GroupEmployeeResponsePagedList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GroupEmployeeResponsePagedList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
