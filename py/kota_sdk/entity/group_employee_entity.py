...
class GroupEmployeeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GroupEmployeeEntity(self._client, opts)
    ...
    def data_get(self) -> GroupEmployee:
    ...
    def match_get(self) -> GroupEmployee:
    ...
    def create(self, reqdata: GroupEmployeeCreateData, ctrl=None) -> GroupEmployee:
        utility = self._utility
