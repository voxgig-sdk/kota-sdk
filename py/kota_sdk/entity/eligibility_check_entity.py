...
class EligibilityCheckEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EligibilityCheckEntity(self._client, opts)
    ...
    def data_get(self) -> EligibilityCheck:
    ...
    def match_get(self) -> EligibilityCheck:
    ...
    def create(self, reqdata: EligibilityCheckCreateData, ctrl=None) -> EligibilityCheck:
        utility = self._utility
