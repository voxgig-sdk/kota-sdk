...
from kota_sdk.kota_types import (
    ...
    EnrolmentIntentRequirementResponsePagedListListMatch,
)
...
class EnrolmentIntentRequirementResponsePagedListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EnrolmentIntentRequirementResponsePagedListEntity(self._client, opts)
    ...
    def data_get(self) -> EnrolmentIntentRequirementResponsePagedList:
    ...
    def match_get(self) -> EnrolmentIntentRequirementResponsePagedList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EnrolmentIntentRequirementResponsePagedList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EnrolmentIntentRequirementResponsePagedList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
