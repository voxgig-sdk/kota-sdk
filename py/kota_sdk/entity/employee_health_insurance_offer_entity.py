...
class EmployeeHealthInsuranceOfferEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmployeeHealthInsuranceOfferEntity(self._client, opts)
    ...
    def data_get(self) -> EmployeeHealthInsuranceOffer:
    ...
    def match_get(self) -> EmployeeHealthInsuranceOffer:
    ...
    def load(self, reqmatch=None, ctrl=None) -> EmployeeHealthInsuranceOffer:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.EmployeeHealthInsuranceOffer().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
