...
class CreateSessionTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CreateSessionTokenEntity(self._client, opts)
    ...
    def data_get(self) -> CreateSessionToken:
    ...
    def match_get(self) -> CreateSessionToken:
    ...
    def create(self, reqdata: CreateSessionTokenCreateData, ctrl=None) -> CreateSessionToken:
        utility = self._utility
