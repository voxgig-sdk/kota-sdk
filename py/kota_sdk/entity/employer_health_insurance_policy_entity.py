...
class EmployerHealthInsurancePolicyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmployerHealthInsurancePolicyEntity(self._client, opts)
    ...
    def data_get(self) -> EmployerHealthInsurancePolicy:
    ...
    def match_get(self) -> EmployerHealthInsurancePolicy:
    ...
    def load(self, reqmatch=None, ctrl=None) -> EmployerHealthInsurancePolicy:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.EmployerHealthInsurancePolicy().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
