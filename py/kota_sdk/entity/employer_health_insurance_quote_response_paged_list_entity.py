...
class EmployerHealthInsuranceQuoteResponsePagedListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmployerHealthInsuranceQuoteResponsePagedListEntity(self._client, opts)
    ...
    def data_get(self) -> EmployerHealthInsuranceQuoteResponsePagedList:
    ...
    def match_get(self) -> EmployerHealthInsuranceQuoteResponsePagedList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EmployerHealthInsuranceQuoteResponsePagedList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EmployerHealthInsuranceQuoteResponsePagedList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
