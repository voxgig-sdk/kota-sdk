...
from kota_sdk.core.helpers import get_ctx_prop, to_map
...
class KotaContext:
    ...
    def make_error(self, code, msg):
        return KotaError(code, msg, self)
