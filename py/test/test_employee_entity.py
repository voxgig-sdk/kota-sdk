...
class TestEmployeeEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        employee_ref01_data = helpers.to_map(runner.entity_data(employee_ref01_ent.create(employee_ref01_data, None)))
        ...
        employee_ref01_resdata_up0 = helpers.to_map(runner.entity_data(employee_ref01_ent.update(employee_ref01_data_up0_up, None)))
        ...
        employee_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(employee_ref01_data_dt0_loaded))
