...
class TestCreateHostedSessionTokenEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        create_hosted_session_token_ref01_data = helpers.to_map(runner.entity_data(create_hosted_session_token_ref01_ent.create(create_hosted_session_token_ref01_data, None)))
