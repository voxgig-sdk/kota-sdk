# Kota SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KotaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KotaSDK(...) and KotaSDK.test(...) become
#      KotaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_ENTITIES = {
    "AssociatedPerson": "associated_person",
    "AssociatedPersonEligibilityResponsePagedList": "associated_person_eligibility_response_paged_list",
    "ContributionReport": "contribution_report",
    "ContributionReportEmployeeBreakdown": "contribution_report_employee_breakdown",
    "ContributionReportEmployeeBreakdownResponsePagedList": "contribution_report_employee_breakdown_response_paged_list",
    "CreateHostedSessionToken": "create_hosted_session_token",
    "CreateSessionToken": "create_session_token",
    "Dependent": "dependent",
    "DependentsManagementIntent": "dependents_management_intent",
    "EligibilityCheck": "eligibility_check",
    "Employee": "employee",
    "EmployeeHealthInsuranceOffer": "employee_health_insurance_offer",
    "EmployeeHealthInsuranceOfferResponsePagedList": "employee_health_insurance_offer_response_paged_list",
    "EmployeeHealthInsurancePolicy": "employee_health_insurance_policy",
    "EmployeeHealthInsurancePolicyResponsePagedList": "employee_health_insurance_policy_response_paged_list",
    "Employer": "employer",
    "EmployerHealthInsurancePolicy": "employer_health_insurance_policy",
    "EmployerHealthInsurancePolicyResponsePagedList": "employer_health_insurance_policy_response_paged_list",
    "EmployerHealthInsuranceQuote": "employer_health_insurance_quote",
    "EmployerHealthInsuranceQuoteResponsePagedList": "employer_health_insurance_quote_response_paged_list",
    "EnrolmentIntent": "enrolment_intent",
    "EnrolmentIntentRequirementResponsePagedList": "enrolment_intent_requirement_response_paged_list",
    "Event": "event",
    "Group": "group",
    "GroupEmployee": "group_employee",
    "GroupEmployeeResponsePagedList": "group_employee_response_paged_list",
    "GroupPolicy": "group_policy",
    "GroupPolicyIntent": "group_policy_intent",
    "GroupPolicyIntentRequirementResponsePagedList": "group_policy_intent_requirement_response_paged_list",
    "GroupQuote": "group_quote",
    "GroupQuoteIntent": "group_quote_intent",
    "GroupQuoteIntentRequirementResponsePagedList": "group_quote_intent_requirement_response_paged_list",
    "Plan": "plan",
    "Policy": "policy",
    "PolicyAmendmentIntent": "policy_amendment_intent",
    "PolicyImportIntent": "policy_import_intent",
    "Provider": "provider",
    "Replay": "replay",
    "WebhookEndpoint": "webhook_endpoint",
    "WebhookEndpointResponsePagedList": "webhook_endpoint_response_paged_list",
}
