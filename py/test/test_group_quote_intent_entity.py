...
class TestGroupQuoteIntentEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        group_quote_intent_ref01_data = helpers.to_map(runner.entity_data(group_quote_intent_ref01_ent.create(group_quote_intent_ref01_data, None)))
        ...
        group_quote_intent_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(group_quote_intent_ref01_data_dt0_loaded))
