...
from kota_sdk.core.response import KotaResponse
from kota_sdk.core.operation import KotaOperation
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = KotaSDK.test(None, None)
        ...
        class TestInitFeature(KotaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(KotaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = KotaSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = KotaSDK.test(None, setup_opts)
