...
from core.utility_type import KotaUtility
...
class KotaSDK:
    ...
    def AssociatedPerson(self, data=None) -> "AssociatedPersonEntity":
        ...
        from entity.associated_person_entity import AssociatedPersonEntity
    ...
    def AssociatedPersonEligibilityResponsePagedList(self, data=None) -> "AssociatedPersonEligibilityResponsePagedListEntity":
        ...
        from entity.associated_person_eligibility_response_paged_list_entity import AssociatedPersonEligibilityResponsePagedListEntity
    ...
    def ContributionReport(self, data=None) -> "ContributionReportEntity":
        ...
        from entity.contribution_report_entity import ContributionReportEntity
    ...
    def ContributionReportEmployeeBreakdown(self, data=None) -> "ContributionReportEmployeeBreakdownEntity":
        ...
        from entity.contribution_report_employee_breakdown_entity import ContributionReportEmployeeBreakdownEntity
    ...
    def ContributionReportEmployeeBreakdownResponsePagedList(self, data=None) -> "ContributionReportEmployeeBreakdownResponsePagedListEntity":
        ...
        from entity.contribution_report_employee_breakdown_response_paged_list_entity import ContributionReportEmployeeBreakdownResponsePagedListEntity
    ...
    def CreateHostedSessionToken(self, data=None) -> "CreateHostedSessionTokenEntity":
        ...
        from entity.create_hosted_session_token_entity import CreateHostedSessionTokenEntity
    ...
    def CreateSessionToken(self, data=None) -> "CreateSessionTokenEntity":
        ...
        from entity.create_session_token_entity import CreateSessionTokenEntity
    ...
    def Dependent(self, data=None) -> "DependentEntity":
        ...
        from entity.dependent_entity import DependentEntity
    ...
    def DependentsManagementIntent(self, data=None) -> "DependentsManagementIntentEntity":
        ...
        from entity.dependents_management_intent_entity import DependentsManagementIntentEntity
    ...
    def EligibilityCheck(self, data=None) -> "EligibilityCheckEntity":
        ...
        from entity.eligibility_check_entity import EligibilityCheckEntity
    ...
    def Employee(self, data=None) -> "EmployeeEntity":
        ...
        from entity.employee_entity import EmployeeEntity
    ...
    def EmployeeHealthInsuranceOffer(self, data=None) -> "EmployeeHealthInsuranceOfferEntity":
        ...
        from entity.employee_health_insurance_offer_entity import EmployeeHealthInsuranceOfferEntity
    ...
    def EmployeeHealthInsuranceOfferResponsePagedList(self, data=None) -> "EmployeeHealthInsuranceOfferResponsePagedListEntity":
        ...
        from entity.employee_health_insurance_offer_response_paged_list_entity import EmployeeHealthInsuranceOfferResponsePagedListEntity
    ...
    def EmployeeHealthInsurancePolicy(self, data=None) -> "EmployeeHealthInsurancePolicyEntity":
        ...
        from entity.employee_health_insurance_policy_entity import EmployeeHealthInsurancePolicyEntity
    ...
    def EmployeeHealthInsurancePolicyResponsePagedList(self, data=None) -> "EmployeeHealthInsurancePolicyResponsePagedListEntity":
        ...
        from entity.employee_health_insurance_policy_response_paged_list_entity import EmployeeHealthInsurancePolicyResponsePagedListEntity
    ...
    def Employer(self, data=None) -> "EmployerEntity":
        ...
        from entity.employer_entity import EmployerEntity
    ...
    def EmployerHealthInsurancePolicy(self, data=None) -> "EmployerHealthInsurancePolicyEntity":
        ...
        from entity.employer_health_insurance_policy_entity import EmployerHealthInsurancePolicyEntity
    ...
    def EmployerHealthInsurancePolicyResponsePagedList(self, data=None) -> "EmployerHealthInsurancePolicyResponsePagedListEntity":
        ...
        from entity.employer_health_insurance_policy_response_paged_list_entity import EmployerHealthInsurancePolicyResponsePagedListEntity
    ...
    def EmployerHealthInsuranceQuote(self, data=None) -> "EmployerHealthInsuranceQuoteEntity":
        ...
        from entity.employer_health_insurance_quote_entity import EmployerHealthInsuranceQuoteEntity
    ...
    def EmployerHealthInsuranceQuoteResponsePagedList(self, data=None) -> "EmployerHealthInsuranceQuoteResponsePagedListEntity":
        ...
        from entity.employer_health_insurance_quote_response_paged_list_entity import EmployerHealthInsuranceQuoteResponsePagedListEntity
    ...
    def EnrolmentIntent(self, data=None) -> "EnrolmentIntentEntity":
        ...
        from entity.enrolment_intent_entity import EnrolmentIntentEntity
    ...
    def EnrolmentIntentRequirementResponsePagedList(self, data=None) -> "EnrolmentIntentRequirementResponsePagedListEntity":
        ...
        from entity.enrolment_intent_requirement_response_paged_list_entity import EnrolmentIntentRequirementResponsePagedListEntity
    ...
    def GroupEmployee(self, data=None) -> "GroupEmployeeEntity":
        ...
        from entity.group_employee_entity import GroupEmployeeEntity
    ...
    def GroupEmployeeResponsePagedList(self, data=None) -> "GroupEmployeeResponsePagedListEntity":
        ...
        from entity.group_employee_response_paged_list_entity import GroupEmployeeResponsePagedListEntity
    ...
    def GroupPolicy(self, data=None) -> "GroupPolicyEntity":
        ...
        from entity.group_policy_entity import GroupPolicyEntity
    ...
    def GroupPolicyIntent(self, data=None) -> "GroupPolicyIntentEntity":
        ...
        from entity.group_policy_intent_entity import GroupPolicyIntentEntity
    ...
    def GroupPolicyIntentRequirementResponsePagedList(self, data=None) -> "GroupPolicyIntentRequirementResponsePagedListEntity":
        ...
        from entity.group_policy_intent_requirement_response_paged_list_entity import GroupPolicyIntentRequirementResponsePagedListEntity
    ...
    def GroupQuote(self, data=None) -> "GroupQuoteEntity":
        ...
        from entity.group_quote_entity import GroupQuoteEntity
    ...
    def GroupQuoteIntent(self, data=None) -> "GroupQuoteIntentEntity":
        ...
        from entity.group_quote_intent_entity import GroupQuoteIntentEntity
    ...
    def GroupQuoteIntentRequirementResponsePagedList(self, data=None) -> "GroupQuoteIntentRequirementResponsePagedListEntity":
        ...
        from entity.group_quote_intent_requirement_response_paged_list_entity import GroupQuoteIntentRequirementResponsePagedListEntity
    ...
    def PolicyAmendmentIntent(self, data=None) -> "PolicyAmendmentIntentEntity":
        ...
        from entity.policy_amendment_intent_entity import PolicyAmendmentIntentEntity
    ...
    def PolicyImportIntent(self, data=None) -> "PolicyImportIntentEntity":
        ...
        from entity.policy_import_intent_entity import PolicyImportIntentEntity
    ...
    def Replay(self, data=None) -> "ReplayEntity":
        ...
        from entity.replay_entity import ReplayEntity
    ...
    def WebhookEndpointResponsePagedList(self, data=None) -> "WebhookEndpointResponsePagedListEntity":
        ...
        from entity.webhook_endpoint_response_paged_list_entity import WebhookEndpointResponsePagedListEntity
