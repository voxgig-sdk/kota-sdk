...
class KotaPagingFeature extends KotaBaseFeature
{
    ...
    private function _graphql_pre_request(KotaContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(KotaContext $ctx): bool
    {
