...
class KotaTimeoutFeature extends KotaBaseFeature
{
    ...
    private function _with_timeout(KotaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KotaContext $_ctx, float $ms): void
    {
        $client = $this->client;
