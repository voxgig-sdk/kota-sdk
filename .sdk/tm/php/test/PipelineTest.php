...
{
    private static function utility(): KotaUtility
    {
        return new KotaUtility();
    }
    ...
    private static function ctx(array $over = []): KotaContext
    {
        ...
        $ctx->op = new KotaOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof KotaError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new KotaOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = KotaMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new KotaOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = KotaMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new KotaOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = KotaMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KotaSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = KotaMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new KotaResponse([]),
            'result' => new KotaResult([]),
        ]);
        [, $err] = KotaMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new KotaSpec(['step' => 's']),
            'response' => new KotaResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new KotaResult([]),
        ]);
        [, $err] = KotaMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new KotaSpec(['step' => 's']),
            'response' => new KotaResponse(self::resp(200, ['v' => 1])),
            'result' => new KotaResult([]),
        ]);
        [, $err] = KotaMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new KotaSpec(['step' => 's']),
            'response' => new KotaResponse(self::resp(200, ['v' => 2])),
            'result' => new KotaResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        KotaMakeResponse::call($ctx);
    ...
    {
        $preset = new KotaResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new KotaSpec([]),
            'response' => new KotaResponse([]),
            'result' => new KotaResult([]),
        ...
        [$got, $err] = KotaMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new KotaResult([])]);
        [, $err] = KotaMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new KotaSpec([]), 'result' => null]);
        [, $err] = KotaMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KotaSpec(['step' => 's']),
            'result' => new KotaResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new KotaOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KotaMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KotaSpec(['step' => 's']),
            'result' => new KotaResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new KotaOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KotaMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KotaResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new KotaSpec([]),
            'result' => new KotaResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = KotaMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $utility = self::utility();
        $boom = new KotaError('boom', 'boom');
        $utility->fetcher = function (KotaContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KotaSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = KotaMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (KotaContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = KotaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(KotaResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (KotaContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KotaSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = KotaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new KotaResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new KotaSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = KotaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = KotaMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new KotaResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, KotaDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new KotaResult(['ok' => false])]);
        $this->expectException(KotaError::class);
        KotaDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new KotaResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', KotaMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new KotaBaseFeature();
        $b = new KotaBaseFeature();
        KotaFeatureAdd::call($ctx, $a);
        KotaFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): KotaBaseFeature
    {
        $f = new KotaBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    private static function auth_ctx(array $options, ?array $headers): KotaContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new KotaSpec(['headers' => $headers]),
        ]);
    }
    ...
    {
        $ctx = self::ctx([
            'response' => new KotaResponse(['headers' => null]),
            'result' => new KotaResult([]),
        ]);
        KotaResultHeaders::call($ctx);
