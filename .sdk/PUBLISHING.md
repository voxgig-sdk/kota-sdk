...
|---|---|---|
| `js/` | @voxgig-sdk/kota-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/kota | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/kota-js \
      --repository voxgig-sdk/kota-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/kota-js` shows it, and
`npm trust revoke @voxgig-sdk/kota-js --id=<id>` removes it.
