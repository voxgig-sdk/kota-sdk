...
describe("WebhookEndpointEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set KOTA_TEST_WEBHOOK_ENDPOINT_ENTID JSON to run live")
      return
    end
...
function webhook_endpoint_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("KOTA_TEST_WEBHOOK_ENDPOINT_ENTID")
