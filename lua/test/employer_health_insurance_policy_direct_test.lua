-- EmployerHealthInsurancePolicy direct test
...
describe("EmployerHealthInsurancePolicyDirect", function()
  it("should direct-load-employer_health_insurance_policy", function()
    local setup = employer_health_insurance_policy_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-employer_health_insurance_policy", setup.live and "live" or "unit")
...
function employer_health_insurance_policy_direct_setup(mockres)
