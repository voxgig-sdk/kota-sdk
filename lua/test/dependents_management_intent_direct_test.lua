...
describe("DependentsManagementIntentDirect", function()
  it("should direct-load-dependents_management_intent", function()
    local setup = dependents_management_intent_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dependents_management_intent", setup.live and "live" or "unit")
