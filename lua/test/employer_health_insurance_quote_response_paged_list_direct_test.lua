-- EmployerHealthInsuranceQuoteResponsePagedList direct test
...
describe("EmployerHealthInsuranceQuoteResponsePagedListDirect", function()
  it("should direct-list-employer_health_insurance_quote_response_paged_list", function()
    local setup = employer_health_insurance_quote_response_paged_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-employer_health_insurance_quote_response_paged_list", setup.live and "live" or "unit")
...
function employer_health_insurance_quote_response_paged_list_direct_setup(mockres)
