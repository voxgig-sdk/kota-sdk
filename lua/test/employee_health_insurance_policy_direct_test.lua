...
describe("EmployeeHealthInsurancePolicyDirect", function()
  it("should direct-load-employee_health_insurance_policy", function()
    local setup = employee_health_insurance_policy_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-employee_health_insurance_policy", setup.live and "live" or "unit")
