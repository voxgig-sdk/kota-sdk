-- WebhookEndpointResponsePagedList direct test
...
describe("WebhookEndpointResponsePagedListDirect", function()
  it("should direct-list-webhook_endpoint_response_paged_list", function()
    local setup = webhook_endpoint_response_paged_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-webhook_endpoint_response_paged_list", setup.live and "live" or "unit")
...
function webhook_endpoint_response_paged_list_direct_setup(mockres)
