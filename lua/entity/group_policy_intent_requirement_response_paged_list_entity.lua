-- Kota SDK GroupPolicyIntentRequirementResponsePagedList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local GroupPolicyIntentRequirementResponsePagedListEntity = {}
GroupPolicyIntentRequirementResponsePagedListEntity.__index = GroupPolicyIntentRequirementResponsePagedListEntity


function GroupPolicyIntentRequirementResponsePagedListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GroupPolicyIntentRequirementResponsePagedListEntity)
  self._name = "group_policy_intent_requirement_response_paged_list"
  self._client = client
...
function GroupPolicyIntentRequirementResponsePagedListEntity:get_name()
  return self._name
end


function GroupPolicyIntentRequirementResponsePagedListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GroupPolicyIntentRequirementResponsePagedListEntity.new(self._client, opts)
end
...
function GroupPolicyIntentRequirementResponsePagedListEntity:mark_deleted()
  self._deleted = true
end


function GroupPolicyIntentRequirementResponsePagedListEntity:deleted()
  return true == self._deleted
end


function GroupPolicyIntentRequirementResponsePagedListEntity:data_set(args)
  if args ~= nil then
...
function GroupPolicyIntentRequirementResponsePagedListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GroupPolicyIntentRequirementResponsePagedListEntity:match_set(args)
  if args ~= nil then
...
function GroupPolicyIntentRequirementResponsePagedListEntity:match_get()
...
function GroupPolicyIntentRequirementResponsePagedListEntity:stream(action, args, callopts)
...
---@param reqmatch GroupPolicyIntentRequirementResponsePagedListListMatch
---@param ctrl? table
---@return GroupPolicyIntentRequirementResponsePagedList[]
---@return string? err
function GroupPolicyIntentRequirementResponsePagedListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function GroupPolicyIntentRequirementResponsePagedListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GroupPolicyIntentRequirementResponsePagedListEntity
