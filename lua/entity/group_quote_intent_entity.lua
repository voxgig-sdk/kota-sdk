...
local GroupQuoteIntentEntity = {}
GroupQuoteIntentEntity.__index = GroupQuoteIntentEntity


function GroupQuoteIntentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GroupQuoteIntentEntity)
  self._name = "group_quote_intent"
  self._client = client
...
function GroupQuoteIntentEntity:get_name()
  return self._name
end


function GroupQuoteIntentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GroupQuoteIntentEntity.new(self._client, opts)
end
...
function GroupQuoteIntentEntity:mark_deleted()
  self._deleted = true
end


function GroupQuoteIntentEntity:deleted()
  return true == self._deleted
end


function GroupQuoteIntentEntity:data_set(args)
  if args ~= nil then
...
function GroupQuoteIntentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GroupQuoteIntentEntity:match_set(args)
  if args ~= nil then
...
function GroupQuoteIntentEntity:match_get()
...
function GroupQuoteIntentEntity:stream(action, args, callopts)
...
---@param reqmatch GroupQuoteIntentLoadMatch
---@param ctrl? table
---@return GroupQuoteIntent
---@return string? err
function GroupQuoteIntentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch GroupQuoteIntentListMatch
---@param ctrl? table
---@return GroupQuoteIntent[]
---@return string? err
function GroupQuoteIntentEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata GroupQuoteIntentCreateData
---@param ctrl? table
---@return GroupQuoteIntent
---@return string? err
function GroupQuoteIntentEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function GroupQuoteIntentEntity:_run_op(ctx, post_done)
  local utility = self._utility
