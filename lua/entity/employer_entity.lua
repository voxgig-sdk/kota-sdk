...
local EmployerEntity = {}
EmployerEntity.__index = EmployerEntity


function EmployerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmployerEntity)
  self._name = "employer"
  self._client = client
...
function EmployerEntity:get_name()
  return self._name
end


function EmployerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmployerEntity.new(self._client, opts)
end
...
function EmployerEntity:mark_deleted()
  self._deleted = true
end


function EmployerEntity:deleted()
  return true == self._deleted
end


function EmployerEntity:data_set(args)
  if args ~= nil then
...
function EmployerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmployerEntity:match_set(args)
  if args ~= nil then
...
function EmployerEntity:match_get()
...
function EmployerEntity:stream(action, args, callopts)
...
---@param reqmatch EmployerLoadMatch
---@param ctrl? table
---@return Employer
---@return string? err
function EmployerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch EmployerListMatch
---@param ctrl? table
---@return Employer[]
---@return string? err
function EmployerEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata EmployerCreateData
---@param ctrl? table
---@return Employer
---@return string? err
function EmployerEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata EmployerUpdateData
---@param ctrl? table
---@return Employer
---@return string? err
function EmployerEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function EmployerEntity:_run_op(ctx, post_done)
  local utility = self._utility
