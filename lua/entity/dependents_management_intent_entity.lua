...
local DependentsManagementIntentEntity = {}
DependentsManagementIntentEntity.__index = DependentsManagementIntentEntity


function DependentsManagementIntentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DependentsManagementIntentEntity)
  self._name = "dependents_management_intent"
  self._client = client
...
function DependentsManagementIntentEntity:get_name()
  return self._name
end


function DependentsManagementIntentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DependentsManagementIntentEntity.new(self._client, opts)
end
...
function DependentsManagementIntentEntity:mark_deleted()
  self._deleted = true
end


function DependentsManagementIntentEntity:deleted()
  return true == self._deleted
end


function DependentsManagementIntentEntity:data_set(args)
  if args ~= nil then
...
function DependentsManagementIntentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DependentsManagementIntentEntity:match_set(args)
  if args ~= nil then
...
function DependentsManagementIntentEntity:match_get()
...
function DependentsManagementIntentEntity:stream(action, args, callopts)
...
---@param reqmatch DependentsManagementIntentLoadMatch
---@param ctrl? table
---@return DependentsManagementIntent
---@return string? err
function DependentsManagementIntentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata DependentsManagementIntentCreateData
---@param ctrl? table
---@return DependentsManagementIntent
---@return string? err
function DependentsManagementIntentEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function DependentsManagementIntentEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DependentsManagementIntentEntity
