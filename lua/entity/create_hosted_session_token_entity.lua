-- Kota SDK CreateHostedSessionToken entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CreateHostedSessionTokenEntity = {}
CreateHostedSessionTokenEntity.__index = CreateHostedSessionTokenEntity


function CreateHostedSessionTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CreateHostedSessionTokenEntity)
  self._name = "create_hosted_session_token"
  self._client = client
...
function CreateHostedSessionTokenEntity:get_name()
  return self._name
end


function CreateHostedSessionTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CreateHostedSessionTokenEntity.new(self._client, opts)
end
...
function CreateHostedSessionTokenEntity:mark_deleted()
  self._deleted = true
end


function CreateHostedSessionTokenEntity:deleted()
  return true == self._deleted
end


function CreateHostedSessionTokenEntity:data_set(args)
  if args ~= nil then
...
function CreateHostedSessionTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CreateHostedSessionTokenEntity:match_set(args)
  if args ~= nil then
...
function CreateHostedSessionTokenEntity:match_get()
...
function CreateHostedSessionTokenEntity:stream(action, args, callopts)
...
---@param reqdata CreateHostedSessionTokenCreateData
---@param ctrl? table
---@return CreateHostedSessionToken
---@return string? err
function CreateHostedSessionTokenEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CreateHostedSessionTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CreateHostedSessionTokenEntity
