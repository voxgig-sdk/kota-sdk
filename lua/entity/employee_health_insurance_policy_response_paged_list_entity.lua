-- Kota SDK EmployeeHealthInsurancePolicyResponsePagedList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local EmployeeHealthInsurancePolicyResponsePagedListEntity = {}
EmployeeHealthInsurancePolicyResponsePagedListEntity.__index = EmployeeHealthInsurancePolicyResponsePagedListEntity


function EmployeeHealthInsurancePolicyResponsePagedListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmployeeHealthInsurancePolicyResponsePagedListEntity)
  self._name = "employee_health_insurance_policy_response_paged_list"
  self._client = client
...
function EmployeeHealthInsurancePolicyResponsePagedListEntity:get_name()
  return self._name
end


function EmployeeHealthInsurancePolicyResponsePagedListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmployeeHealthInsurancePolicyResponsePagedListEntity.new(self._client, opts)
end
...
function EmployeeHealthInsurancePolicyResponsePagedListEntity:mark_deleted()
  self._deleted = true
end


function EmployeeHealthInsurancePolicyResponsePagedListEntity:deleted()
  return true == self._deleted
end


function EmployeeHealthInsurancePolicyResponsePagedListEntity:data_set(args)
  if args ~= nil then
...
function EmployeeHealthInsurancePolicyResponsePagedListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmployeeHealthInsurancePolicyResponsePagedListEntity:match_set(args)
  if args ~= nil then
...
function EmployeeHealthInsurancePolicyResponsePagedListEntity:match_get()
...
function EmployeeHealthInsurancePolicyResponsePagedListEntity:stream(action, args, callopts)
...
---@param reqmatch EmployeeHealthInsurancePolicyResponsePagedListListMatch
---@param ctrl? table
---@return EmployeeHealthInsurancePolicyResponsePagedList[]
---@return string? err
function EmployeeHealthInsurancePolicyResponsePagedListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function EmployeeHealthInsurancePolicyResponsePagedListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EmployeeHealthInsurancePolicyResponsePagedListEntity
