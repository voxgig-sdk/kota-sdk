-- Kota SDK EmployeeHealthInsurancePolicy entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local EmployeeHealthInsurancePolicyEntity = {}
EmployeeHealthInsurancePolicyEntity.__index = EmployeeHealthInsurancePolicyEntity


function EmployeeHealthInsurancePolicyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmployeeHealthInsurancePolicyEntity)
  self._name = "employee_health_insurance_policy"
  self._client = client
...
function EmployeeHealthInsurancePolicyEntity:get_name()
  return self._name
end


function EmployeeHealthInsurancePolicyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmployeeHealthInsurancePolicyEntity.new(self._client, opts)
end
...
function EmployeeHealthInsurancePolicyEntity:mark_deleted()
  self._deleted = true
end


function EmployeeHealthInsurancePolicyEntity:deleted()
  return true == self._deleted
end


function EmployeeHealthInsurancePolicyEntity:data_set(args)
  if args ~= nil then
...
function EmployeeHealthInsurancePolicyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmployeeHealthInsurancePolicyEntity:match_set(args)
  if args ~= nil then
...
function EmployeeHealthInsurancePolicyEntity:match_get()
...
function EmployeeHealthInsurancePolicyEntity:stream(action, args, callopts)
...
---@param reqmatch EmployeeHealthInsurancePolicyLoadMatch
---@param ctrl? table
---@return EmployeeHealthInsurancePolicy
---@return string? err
function EmployeeHealthInsurancePolicyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function EmployeeHealthInsurancePolicyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EmployeeHealthInsurancePolicyEntity
