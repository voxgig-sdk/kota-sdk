...
local ContributionReportEntity = {}
ContributionReportEntity.__index = ContributionReportEntity


function ContributionReportEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ContributionReportEntity)
  self._name = "contribution_report"
  self._client = client
...
function ContributionReportEntity:get_name()
  return self._name
end


function ContributionReportEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ContributionReportEntity.new(self._client, opts)
end
...
function ContributionReportEntity:mark_deleted()
  self._deleted = true
end


function ContributionReportEntity:deleted()
  return true == self._deleted
end


function ContributionReportEntity:data_set(args)
  if args ~= nil then
...
function ContributionReportEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ContributionReportEntity:match_set(args)
  if args ~= nil then
...
function ContributionReportEntity:match_get()
...
function ContributionReportEntity:stream(action, args, callopts)
...
---@param reqmatch ContributionReportLoadMatch
---@param ctrl? table
---@return ContributionReport
---@return string? err
function ContributionReportEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ContributionReportListMatch
---@param ctrl? table
---@return ContributionReport[]
---@return string? err
function ContributionReportEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ContributionReportCreateData
---@param ctrl? table
---@return ContributionReport
---@return string? err
function ContributionReportEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ContributionReportEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ContributionReportEntity
