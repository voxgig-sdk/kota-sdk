...
local AssociatedPersonEntity = {}
AssociatedPersonEntity.__index = AssociatedPersonEntity


function AssociatedPersonEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AssociatedPersonEntity)
  self._name = "associated_person"
  self._client = client
...
function AssociatedPersonEntity:get_name()
  return self._name
end


function AssociatedPersonEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AssociatedPersonEntity.new(self._client, opts)
end
...
function AssociatedPersonEntity:mark_deleted()
  self._deleted = true
end


function AssociatedPersonEntity:deleted()
  return true == self._deleted
end


function AssociatedPersonEntity:data_set(args)
  if args ~= nil then
...
function AssociatedPersonEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AssociatedPersonEntity:match_set(args)
  if args ~= nil then
...
function AssociatedPersonEntity:match_get()
...
function AssociatedPersonEntity:stream(action, args, callopts)
...
---@param reqmatch AssociatedPersonLoadMatch
---@param ctrl? table
---@return AssociatedPerson
---@return string? err
function AssociatedPersonEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch AssociatedPersonListMatch
---@param ctrl? table
---@return AssociatedPerson[]
---@return string? err
function AssociatedPersonEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata AssociatedPersonCreateData
---@param ctrl? table
---@return AssociatedPerson
---@return string? err
function AssociatedPersonEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata AssociatedPersonUpdateData
---@param ctrl? table
---@return AssociatedPerson
---@return string? err
function AssociatedPersonEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch AssociatedPersonRemoveMatch
---@param ctrl? table
---@return AssociatedPerson
---@return string? err
function AssociatedPersonEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function AssociatedPersonEntity:_run_op(ctx, post_done)
  local utility = self._utility
