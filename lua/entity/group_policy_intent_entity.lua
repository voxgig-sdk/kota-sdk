...
local GroupPolicyIntentEntity = {}
GroupPolicyIntentEntity.__index = GroupPolicyIntentEntity


function GroupPolicyIntentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GroupPolicyIntentEntity)
  self._name = "group_policy_intent"
  self._client = client
...
function GroupPolicyIntentEntity:get_name()
  return self._name
end


function GroupPolicyIntentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GroupPolicyIntentEntity.new(self._client, opts)
end
...
function GroupPolicyIntentEntity:mark_deleted()
  self._deleted = true
end


function GroupPolicyIntentEntity:deleted()
  return true == self._deleted
end


function GroupPolicyIntentEntity:data_set(args)
  if args ~= nil then
...
function GroupPolicyIntentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GroupPolicyIntentEntity:match_set(args)
  if args ~= nil then
...
function GroupPolicyIntentEntity:match_get()
...
function GroupPolicyIntentEntity:stream(action, args, callopts)
...
---@param reqmatch GroupPolicyIntentLoadMatch
---@param ctrl? table
---@return GroupPolicyIntent
---@return string? err
function GroupPolicyIntentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch GroupPolicyIntentListMatch
---@param ctrl? table
---@return GroupPolicyIntent[]
---@return string? err
function GroupPolicyIntentEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata GroupPolicyIntentCreateData
---@param ctrl? table
---@return GroupPolicyIntent
---@return string? err
function GroupPolicyIntentEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function GroupPolicyIntentEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GroupPolicyIntentEntity
