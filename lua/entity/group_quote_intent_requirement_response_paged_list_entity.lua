-- Kota SDK GroupQuoteIntentRequirementResponsePagedList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local GroupQuoteIntentRequirementResponsePagedListEntity = {}
GroupQuoteIntentRequirementResponsePagedListEntity.__index = GroupQuoteIntentRequirementResponsePagedListEntity


function GroupQuoteIntentRequirementResponsePagedListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GroupQuoteIntentRequirementResponsePagedListEntity)
  self._name = "group_quote_intent_requirement_response_paged_list"
  self._client = client
...
function GroupQuoteIntentRequirementResponsePagedListEntity:get_name()
  return self._name
end


function GroupQuoteIntentRequirementResponsePagedListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GroupQuoteIntentRequirementResponsePagedListEntity.new(self._client, opts)
end
...
function GroupQuoteIntentRequirementResponsePagedListEntity:mark_deleted()
  self._deleted = true
end


function GroupQuoteIntentRequirementResponsePagedListEntity:deleted()
  return true == self._deleted
end


function GroupQuoteIntentRequirementResponsePagedListEntity:data_set(args)
  if args ~= nil then
...
function GroupQuoteIntentRequirementResponsePagedListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GroupQuoteIntentRequirementResponsePagedListEntity:match_set(args)
  if args ~= nil then
...
function GroupQuoteIntentRequirementResponsePagedListEntity:match_get()
...
function GroupQuoteIntentRequirementResponsePagedListEntity:stream(action, args, callopts)
...
---@param reqmatch GroupQuoteIntentRequirementResponsePagedListListMatch
---@param ctrl? table
---@return GroupQuoteIntentRequirementResponsePagedList[]
---@return string? err
function GroupQuoteIntentRequirementResponsePagedListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function GroupQuoteIntentRequirementResponsePagedListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GroupQuoteIntentRequirementResponsePagedListEntity
