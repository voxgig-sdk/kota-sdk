-- Kota SDK EmployerHealthInsurancePolicyResponsePagedList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local EmployerHealthInsurancePolicyResponsePagedListEntity = {}
EmployerHealthInsurancePolicyResponsePagedListEntity.__index = EmployerHealthInsurancePolicyResponsePagedListEntity


function EmployerHealthInsurancePolicyResponsePagedListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmployerHealthInsurancePolicyResponsePagedListEntity)
  self._name = "employer_health_insurance_policy_response_paged_list"
  self._client = client
...
function EmployerHealthInsurancePolicyResponsePagedListEntity:get_name()
  return self._name
end


function EmployerHealthInsurancePolicyResponsePagedListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmployerHealthInsurancePolicyResponsePagedListEntity.new(self._client, opts)
end
...
function EmployerHealthInsurancePolicyResponsePagedListEntity:mark_deleted()
  self._deleted = true
end


function EmployerHealthInsurancePolicyResponsePagedListEntity:deleted()
  return true == self._deleted
end


function EmployerHealthInsurancePolicyResponsePagedListEntity:data_set(args)
  if args ~= nil then
...
function EmployerHealthInsurancePolicyResponsePagedListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmployerHealthInsurancePolicyResponsePagedListEntity:match_set(args)
  if args ~= nil then
...
function EmployerHealthInsurancePolicyResponsePagedListEntity:match_get()
...
function EmployerHealthInsurancePolicyResponsePagedListEntity:stream(action, args, callopts)
...
---@param reqmatch EmployerHealthInsurancePolicyResponsePagedListListMatch
---@param ctrl? table
---@return EmployerHealthInsurancePolicyResponsePagedList[]
---@return string? err
function EmployerHealthInsurancePolicyResponsePagedListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function EmployerHealthInsurancePolicyResponsePagedListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EmployerHealthInsurancePolicyResponsePagedListEntity
