-- Kota SDK EmployeeHealthInsuranceOfferResponsePagedList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local EmployeeHealthInsuranceOfferResponsePagedListEntity = {}
EmployeeHealthInsuranceOfferResponsePagedListEntity.__index = EmployeeHealthInsuranceOfferResponsePagedListEntity


function EmployeeHealthInsuranceOfferResponsePagedListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmployeeHealthInsuranceOfferResponsePagedListEntity)
  self._name = "employee_health_insurance_offer_response_paged_list"
  self._client = client
...
function EmployeeHealthInsuranceOfferResponsePagedListEntity:get_name()
  return self._name
end


function EmployeeHealthInsuranceOfferResponsePagedListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmployeeHealthInsuranceOfferResponsePagedListEntity.new(self._client, opts)
end
...
function EmployeeHealthInsuranceOfferResponsePagedListEntity:mark_deleted()
  self._deleted = true
end


function EmployeeHealthInsuranceOfferResponsePagedListEntity:deleted()
  return true == self._deleted
end


function EmployeeHealthInsuranceOfferResponsePagedListEntity:data_set(args)
  if args ~= nil then
...
function EmployeeHealthInsuranceOfferResponsePagedListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmployeeHealthInsuranceOfferResponsePagedListEntity:match_set(args)
  if args ~= nil then
...
function EmployeeHealthInsuranceOfferResponsePagedListEntity:match_get()
...
function EmployeeHealthInsuranceOfferResponsePagedListEntity:stream(action, args, callopts)
...
---@param reqmatch EmployeeHealthInsuranceOfferResponsePagedListListMatch
---@param ctrl? table
---@return EmployeeHealthInsuranceOfferResponsePagedList[]
---@return string? err
function EmployeeHealthInsuranceOfferResponsePagedListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function EmployeeHealthInsuranceOfferResponsePagedListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EmployeeHealthInsuranceOfferResponsePagedListEntity
