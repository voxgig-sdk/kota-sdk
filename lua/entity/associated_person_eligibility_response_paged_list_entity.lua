-- Kota SDK AssociatedPersonEligibilityResponsePagedList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local AssociatedPersonEligibilityResponsePagedListEntity = {}
AssociatedPersonEligibilityResponsePagedListEntity.__index = AssociatedPersonEligibilityResponsePagedListEntity


function AssociatedPersonEligibilityResponsePagedListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AssociatedPersonEligibilityResponsePagedListEntity)
  self._name = "associated_person_eligibility_response_paged_list"
  self._client = client
...
function AssociatedPersonEligibilityResponsePagedListEntity:get_name()
  return self._name
end


function AssociatedPersonEligibilityResponsePagedListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AssociatedPersonEligibilityResponsePagedListEntity.new(self._client, opts)
end
...
function AssociatedPersonEligibilityResponsePagedListEntity:mark_deleted()
  self._deleted = true
end


function AssociatedPersonEligibilityResponsePagedListEntity:deleted()
  return true == self._deleted
end


function AssociatedPersonEligibilityResponsePagedListEntity:data_set(args)
  if args ~= nil then
...
function AssociatedPersonEligibilityResponsePagedListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AssociatedPersonEligibilityResponsePagedListEntity:match_set(args)
  if args ~= nil then
...
function AssociatedPersonEligibilityResponsePagedListEntity:match_get()
...
function AssociatedPersonEligibilityResponsePagedListEntity:stream(action, args, callopts)
...
---@param reqmatch AssociatedPersonEligibilityResponsePagedListListMatch
---@param ctrl? table
---@return AssociatedPersonEligibilityResponsePagedList[]
---@return string? err
function AssociatedPersonEligibilityResponsePagedListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function AssociatedPersonEligibilityResponsePagedListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AssociatedPersonEligibilityResponsePagedListEntity
