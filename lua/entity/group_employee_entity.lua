...
local GroupEmployeeEntity = {}
GroupEmployeeEntity.__index = GroupEmployeeEntity


function GroupEmployeeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GroupEmployeeEntity)
  self._name = "group_employee"
  self._client = client
...
function GroupEmployeeEntity:get_name()
  return self._name
end


function GroupEmployeeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GroupEmployeeEntity.new(self._client, opts)
end
...
function GroupEmployeeEntity:mark_deleted()
  self._deleted = true
end


function GroupEmployeeEntity:deleted()
  return true == self._deleted
end


function GroupEmployeeEntity:data_set(args)
  if args ~= nil then
...
function GroupEmployeeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GroupEmployeeEntity:match_set(args)
  if args ~= nil then
...
function GroupEmployeeEntity:match_get()
...
function GroupEmployeeEntity:stream(action, args, callopts)
...
---@param reqdata GroupEmployeeCreateData
---@param ctrl? table
---@return GroupEmployee
---@return string? err
function GroupEmployeeEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function GroupEmployeeEntity:_run_op(ctx, post_done)
  local utility = self._utility
