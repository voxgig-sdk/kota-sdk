-- Kota SDK ContributionReportEmployeeBreakdownResponsePagedList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ContributionReportEmployeeBreakdownResponsePagedListEntity = {}
ContributionReportEmployeeBreakdownResponsePagedListEntity.__index = ContributionReportEmployeeBreakdownResponsePagedListEntity


function ContributionReportEmployeeBreakdownResponsePagedListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ContributionReportEmployeeBreakdownResponsePagedListEntity)
  self._name = "contribution_report_employee_breakdown_response_paged_list"
  self._client = client
...
function ContributionReportEmployeeBreakdownResponsePagedListEntity:get_name()
  return self._name
end


function ContributionReportEmployeeBreakdownResponsePagedListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ContributionReportEmployeeBreakdownResponsePagedListEntity.new(self._client, opts)
end
...
function ContributionReportEmployeeBreakdownResponsePagedListEntity:mark_deleted()
  self._deleted = true
end


function ContributionReportEmployeeBreakdownResponsePagedListEntity:deleted()
  return true == self._deleted
end


function ContributionReportEmployeeBreakdownResponsePagedListEntity:data_set(args)
  if args ~= nil then
...
function ContributionReportEmployeeBreakdownResponsePagedListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ContributionReportEmployeeBreakdownResponsePagedListEntity:match_set(args)
  if args ~= nil then
...
function ContributionReportEmployeeBreakdownResponsePagedListEntity:match_get()
...
function ContributionReportEmployeeBreakdownResponsePagedListEntity:stream(action, args, callopts)
...
---@param reqmatch ContributionReportEmployeeBreakdownResponsePagedListListMatch
---@param ctrl? table
---@return ContributionReportEmployeeBreakdownResponsePagedList[]
---@return string? err
function ContributionReportEmployeeBreakdownResponsePagedListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ContributionReportEmployeeBreakdownResponsePagedListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ContributionReportEmployeeBreakdownResponsePagedListEntity
