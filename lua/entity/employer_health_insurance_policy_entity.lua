-- Kota SDK EmployerHealthInsurancePolicy entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local EmployerHealthInsurancePolicyEntity = {}
EmployerHealthInsurancePolicyEntity.__index = EmployerHealthInsurancePolicyEntity


function EmployerHealthInsurancePolicyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmployerHealthInsurancePolicyEntity)
  self._name = "employer_health_insurance_policy"
  self._client = client
...
function EmployerHealthInsurancePolicyEntity:get_name()
  return self._name
end


function EmployerHealthInsurancePolicyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmployerHealthInsurancePolicyEntity.new(self._client, opts)
end
...
function EmployerHealthInsurancePolicyEntity:mark_deleted()
  self._deleted = true
end


function EmployerHealthInsurancePolicyEntity:deleted()
  return true == self._deleted
end


function EmployerHealthInsurancePolicyEntity:data_set(args)
  if args ~= nil then
...
function EmployerHealthInsurancePolicyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmployerHealthInsurancePolicyEntity:match_set(args)
  if args ~= nil then
...
function EmployerHealthInsurancePolicyEntity:match_get()
...
function EmployerHealthInsurancePolicyEntity:stream(action, args, callopts)
...
---@param reqmatch EmployerHealthInsurancePolicyLoadMatch
---@param ctrl? table
---@return EmployerHealthInsurancePolicy
---@return string? err
function EmployerHealthInsurancePolicyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function EmployerHealthInsurancePolicyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EmployerHealthInsurancePolicyEntity
