-- Kota SDK EmployerHealthInsuranceQuoteResponsePagedList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local EmployerHealthInsuranceQuoteResponsePagedListEntity = {}
EmployerHealthInsuranceQuoteResponsePagedListEntity.__index = EmployerHealthInsuranceQuoteResponsePagedListEntity


function EmployerHealthInsuranceQuoteResponsePagedListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmployerHealthInsuranceQuoteResponsePagedListEntity)
  self._name = "employer_health_insurance_quote_response_paged_list"
  self._client = client
...
function EmployerHealthInsuranceQuoteResponsePagedListEntity:get_name()
  return self._name
end


function EmployerHealthInsuranceQuoteResponsePagedListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmployerHealthInsuranceQuoteResponsePagedListEntity.new(self._client, opts)
end
...
function EmployerHealthInsuranceQuoteResponsePagedListEntity:mark_deleted()
  self._deleted = true
end


function EmployerHealthInsuranceQuoteResponsePagedListEntity:deleted()
  return true == self._deleted
end


function EmployerHealthInsuranceQuoteResponsePagedListEntity:data_set(args)
  if args ~= nil then
...
function EmployerHealthInsuranceQuoteResponsePagedListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmployerHealthInsuranceQuoteResponsePagedListEntity:match_set(args)
  if args ~= nil then
...
function EmployerHealthInsuranceQuoteResponsePagedListEntity:match_get()
...
function EmployerHealthInsuranceQuoteResponsePagedListEntity:stream(action, args, callopts)
...
---@param reqmatch EmployerHealthInsuranceQuoteResponsePagedListListMatch
---@param ctrl? table
---@return EmployerHealthInsuranceQuoteResponsePagedList[]
---@return string? err
function EmployerHealthInsuranceQuoteResponsePagedListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function EmployerHealthInsuranceQuoteResponsePagedListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EmployerHealthInsuranceQuoteResponsePagedListEntity
