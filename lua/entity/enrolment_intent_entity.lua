...
local EnrolmentIntentEntity = {}
EnrolmentIntentEntity.__index = EnrolmentIntentEntity


function EnrolmentIntentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EnrolmentIntentEntity)
  self._name = "enrolment_intent"
  self._client = client
...
function EnrolmentIntentEntity:get_name()
  return self._name
end


function EnrolmentIntentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EnrolmentIntentEntity.new(self._client, opts)
end
...
function EnrolmentIntentEntity:mark_deleted()
  self._deleted = true
end


function EnrolmentIntentEntity:deleted()
  return true == self._deleted
end


function EnrolmentIntentEntity:data_set(args)
  if args ~= nil then
...
function EnrolmentIntentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EnrolmentIntentEntity:match_set(args)
  if args ~= nil then
...
function EnrolmentIntentEntity:match_get()
...
function EnrolmentIntentEntity:stream(action, args, callopts)
...
---@param reqmatch EnrolmentIntentLoadMatch
---@param ctrl? table
---@return EnrolmentIntent
---@return string? err
function EnrolmentIntentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch EnrolmentIntentListMatch
---@param ctrl? table
---@return EnrolmentIntent[]
---@return string? err
function EnrolmentIntentEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata EnrolmentIntentCreateData
---@param ctrl? table
---@return EnrolmentIntent
---@return string? err
function EnrolmentIntentEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata EnrolmentIntentUpdateData
---@param ctrl? table
---@return EnrolmentIntent
---@return string? err
function EnrolmentIntentEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function EnrolmentIntentEntity:_run_op(ctx, post_done)
  local utility = self._utility
