-- Kota SDK GroupEmployeeResponsePagedList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local GroupEmployeeResponsePagedListEntity = {}
GroupEmployeeResponsePagedListEntity.__index = GroupEmployeeResponsePagedListEntity


function GroupEmployeeResponsePagedListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GroupEmployeeResponsePagedListEntity)
  self._name = "group_employee_response_paged_list"
  self._client = client
...
function GroupEmployeeResponsePagedListEntity:get_name()
  return self._name
end


function GroupEmployeeResponsePagedListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GroupEmployeeResponsePagedListEntity.new(self._client, opts)
end
...
function GroupEmployeeResponsePagedListEntity:mark_deleted()
  self._deleted = true
end


function GroupEmployeeResponsePagedListEntity:deleted()
  return true == self._deleted
end


function GroupEmployeeResponsePagedListEntity:data_set(args)
  if args ~= nil then
...
function GroupEmployeeResponsePagedListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GroupEmployeeResponsePagedListEntity:match_set(args)
  if args ~= nil then
...
function GroupEmployeeResponsePagedListEntity:match_get()
...
function GroupEmployeeResponsePagedListEntity:stream(action, args, callopts)
...
---@param reqmatch GroupEmployeeResponsePagedListListMatch
---@param ctrl? table
---@return GroupEmployeeResponsePagedList[]
---@return string? err
function GroupEmployeeResponsePagedListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function GroupEmployeeResponsePagedListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GroupEmployeeResponsePagedListEntity
