...
local CreateSessionTokenEntity = {}
CreateSessionTokenEntity.__index = CreateSessionTokenEntity


function CreateSessionTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CreateSessionTokenEntity)
  self._name = "create_session_token"
  self._client = client
...
function CreateSessionTokenEntity:get_name()
  return self._name
end


function CreateSessionTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CreateSessionTokenEntity.new(self._client, opts)
end
...
function CreateSessionTokenEntity:mark_deleted()
  self._deleted = true
end


function CreateSessionTokenEntity:deleted()
  return true == self._deleted
end


function CreateSessionTokenEntity:data_set(args)
  if args ~= nil then
...
function CreateSessionTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CreateSessionTokenEntity:match_set(args)
  if args ~= nil then
...
function CreateSessionTokenEntity:match_get()
...
function CreateSessionTokenEntity:stream(action, args, callopts)
...
---@param reqdata CreateSessionTokenCreateData
---@param ctrl? table
---@return CreateSessionToken
---@return string? err
function CreateSessionTokenEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CreateSessionTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CreateSessionTokenEntity
