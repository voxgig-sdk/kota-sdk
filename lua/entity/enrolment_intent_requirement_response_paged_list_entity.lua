-- Kota SDK EnrolmentIntentRequirementResponsePagedList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local EnrolmentIntentRequirementResponsePagedListEntity = {}
EnrolmentIntentRequirementResponsePagedListEntity.__index = EnrolmentIntentRequirementResponsePagedListEntity


function EnrolmentIntentRequirementResponsePagedListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EnrolmentIntentRequirementResponsePagedListEntity)
  self._name = "enrolment_intent_requirement_response_paged_list"
  self._client = client
...
function EnrolmentIntentRequirementResponsePagedListEntity:get_name()
  return self._name
end


function EnrolmentIntentRequirementResponsePagedListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EnrolmentIntentRequirementResponsePagedListEntity.new(self._client, opts)
end
...
function EnrolmentIntentRequirementResponsePagedListEntity:mark_deleted()
  self._deleted = true
end


function EnrolmentIntentRequirementResponsePagedListEntity:deleted()
  return true == self._deleted
end


function EnrolmentIntentRequirementResponsePagedListEntity:data_set(args)
  if args ~= nil then
...
function EnrolmentIntentRequirementResponsePagedListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EnrolmentIntentRequirementResponsePagedListEntity:match_set(args)
  if args ~= nil then
...
function EnrolmentIntentRequirementResponsePagedListEntity:match_get()
...
function EnrolmentIntentRequirementResponsePagedListEntity:stream(action, args, callopts)
...
---@param reqmatch EnrolmentIntentRequirementResponsePagedListListMatch
---@param ctrl? table
---@return EnrolmentIntentRequirementResponsePagedList[]
---@return string? err
function EnrolmentIntentRequirementResponsePagedListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function EnrolmentIntentRequirementResponsePagedListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EnrolmentIntentRequirementResponsePagedListEntity
