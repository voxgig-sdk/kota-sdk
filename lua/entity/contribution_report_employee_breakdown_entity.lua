-- Kota SDK ContributionReportEmployeeBreakdown entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ContributionReportEmployeeBreakdownEntity = {}
ContributionReportEmployeeBreakdownEntity.__index = ContributionReportEmployeeBreakdownEntity


function ContributionReportEmployeeBreakdownEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ContributionReportEmployeeBreakdownEntity)
  self._name = "contribution_report_employee_breakdown"
  self._client = client
...
function ContributionReportEmployeeBreakdownEntity:get_name()
  return self._name
end


function ContributionReportEmployeeBreakdownEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ContributionReportEmployeeBreakdownEntity.new(self._client, opts)
end
...
function ContributionReportEmployeeBreakdownEntity:mark_deleted()
  self._deleted = true
end


function ContributionReportEmployeeBreakdownEntity:deleted()
  return true == self._deleted
end


function ContributionReportEmployeeBreakdownEntity:data_set(args)
  if args ~= nil then
...
function ContributionReportEmployeeBreakdownEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ContributionReportEmployeeBreakdownEntity:match_set(args)
  if args ~= nil then
...
function ContributionReportEmployeeBreakdownEntity:match_get()
...
function ContributionReportEmployeeBreakdownEntity:stream(action, args, callopts)
...
---@param reqmatch ContributionReportEmployeeBreakdownLoadMatch
---@param ctrl? table
---@return ContributionReportEmployeeBreakdown
---@return string? err
function ContributionReportEmployeeBreakdownEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ContributionReportEmployeeBreakdownEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ContributionReportEmployeeBreakdownEntity
