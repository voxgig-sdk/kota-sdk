...
const { AssociatedPersonEntity } = require('./entity/AssociatedPersonEntity')
const { AssociatedPersonEligibilityResponsePagedListEntity } = require('./entity/AssociatedPersonEligibilityResponsePagedListEntity')
const { ContributionReportEntity } = require('./entity/ContributionReportEntity')
const { ContributionReportEmployeeBreakdownEntity } = require('./entity/ContributionReportEmployeeBreakdownEntity')
const { ContributionReportEmployeeBreakdownResponsePagedListEntity } = require('./entity/ContributionReportEmployeeBreakdownResponsePagedListEntity')
const { CreateHostedSessionTokenEntity } = require('./entity/CreateHostedSessionTokenEntity')
const { CreateSessionTokenEntity } = require('./entity/CreateSessionTokenEntity')
const { DependentEntity } = require('./entity/DependentEntity')
const { DependentsManagementIntentEntity } = require('./entity/DependentsManagementIntentEntity')
const { EligibilityCheckEntity } = require('./entity/EligibilityCheckEntity')
const { EmployeeEntity } = require('./entity/EmployeeEntity')
const { EmployeeHealthInsuranceOfferEntity } = require('./entity/EmployeeHealthInsuranceOfferEntity')
const { EmployeeHealthInsuranceOfferResponsePagedListEntity } = require('./entity/EmployeeHealthInsuranceOfferResponsePagedListEntity')
const { EmployeeHealthInsurancePolicyEntity } = require('./entity/EmployeeHealthInsurancePolicyEntity')
const { EmployeeHealthInsurancePolicyResponsePagedListEntity } = require('./entity/EmployeeHealthInsurancePolicyResponsePagedListEntity')
const { EmployerEntity } = require('./entity/EmployerEntity')
const { EmployerHealthInsurancePolicyEntity } = require('./entity/EmployerHealthInsurancePolicyEntity')
const { EmployerHealthInsurancePolicyResponsePagedListEntity } = require('./entity/EmployerHealthInsurancePolicyResponsePagedListEntity')
const { EmployerHealthInsuranceQuoteEntity } = require('./entity/EmployerHealthInsuranceQuoteEntity')
const { EmployerHealthInsuranceQuoteResponsePagedListEntity } = require('./entity/EmployerHealthInsuranceQuoteResponsePagedListEntity')
const { EnrolmentIntentEntity } = require('./entity/EnrolmentIntentEntity')
const { EnrolmentIntentRequirementResponsePagedListEntity } = require('./entity/EnrolmentIntentRequirementResponsePagedListEntity')
const { EventEntity } = require('./entity/EventEntity')
const { GroupEntity } = require('./entity/GroupEntity')
const { GroupEmployeeEntity } = require('./entity/GroupEmployeeEntity')
const { GroupEmployeeResponsePagedListEntity } = require('./entity/GroupEmployeeResponsePagedListEntity')
const { GroupPolicyEntity } = require('./entity/GroupPolicyEntity')
const { GroupPolicyIntentEntity } = require('./entity/GroupPolicyIntentEntity')
const { GroupPolicyIntentRequirementResponsePagedListEntity } = require('./entity/GroupPolicyIntentRequirementResponsePagedListEntity')
const { GroupQuoteEntity } = require('./entity/GroupQuoteEntity')
const { GroupQuoteIntentEntity } = require('./entity/GroupQuoteIntentEntity')
const { GroupQuoteIntentRequirementResponsePagedListEntity } = require('./entity/GroupQuoteIntentRequirementResponsePagedListEntity')
const { PlanEntity } = require('./entity/PlanEntity')
const { PolicyEntity } = require('./entity/PolicyEntity')
const { PolicyAmendmentIntentEntity } = require('./entity/PolicyAmendmentIntentEntity')
const { PolicyImportIntentEntity } = require('./entity/PolicyImportIntentEntity')
const { ProviderEntity } = require('./entity/ProviderEntity')
const { ReplayEntity } = require('./entity/ReplayEntity')
const { WebhookEndpointEntity } = require('./entity/WebhookEndpointEntity')
const { WebhookEndpointResponsePagedListEntity } = require('./entity/WebhookEndpointResponsePagedListEntity')
...
const { KotaEntityBase } = require('./KotaEntityBase')
