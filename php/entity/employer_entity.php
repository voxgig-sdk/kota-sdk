...
class EmployerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EmployerEntity($this->_client, $opts);
    }

    /**
     * @param Employer|array $args Employer data (assoc-array) to store.
     */
    ...
    /**
     * @return Employer|array The current Employer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Employer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Employer fields).
     */
    ...
    /**
     * Load a single Employer.
     *
     * @param EmployerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EmployerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Employer|array The loaded Employer as an assoc-array at the
    ...
    /**
     * List Employer items matching the given filter.
     *
     * @param EmployerListMatch|array|null $reqmatch Match filter (any subset
     *   of Employer fields) as an assoc-array; EmployerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Employer[]|array A list of Employer items as assoc-arrays at
     ...
     *
     * @param EmployerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmployerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Employer|array The created Employer as an assoc-array at the
     *   SDK boundary; throws KotaError on failure (item-5 convention).
     */
     ...
     *
     * @param EmployerUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmployerUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Employer|array The updated Employer as an assoc-array at the
     *   SDK boundary; throws KotaError on failure (item-5 convention).
     */
