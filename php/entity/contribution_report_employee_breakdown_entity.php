...
class ContributionReportEmployeeBreakdownEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "contribution_report_employee_breakdown";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ContributionReportEmployeeBreakdownEntity($this->_client, $opts);
    }

    /**
     * @param ContributionReportEmployeeBreakdown|array $args ContributionReportEmployeeBreakdown data (assoc-array) to store.
     */
    ...
    /**
     * @return ContributionReportEmployeeBreakdown|array The current ContributionReportEmployeeBreakdown data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ContributionReportEmployeeBreakdown fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ContributionReportEmployeeBreakdown fields).
     */
    ...
    /**
     * Load a single ContributionReportEmployeeBreakdown.
     *
     * @param ContributionReportEmployeeBreakdownLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ContributionReportEmployeeBreakdownLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContributionReportEmployeeBreakdown|array The loaded ContributionReportEmployeeBreakdown as an assoc-array at the
