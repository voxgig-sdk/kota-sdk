...
class EmployerHealthInsuranceQuoteEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "employer_health_insurance_quote";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmployerHealthInsuranceQuoteEntity($this->_client, $opts);
    }

    /**
     * @param EmployerHealthInsuranceQuote|array $args EmployerHealthInsuranceQuote data (assoc-array) to store.
     */
    ...
    /**
     * @return EmployerHealthInsuranceQuote|array The current EmployerHealthInsuranceQuote data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmployerHealthInsuranceQuote fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmployerHealthInsuranceQuote fields).
     */
    ...
    /**
     * Load a single EmployerHealthInsuranceQuote.
     *
     * @param EmployerHealthInsuranceQuoteLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EmployerHealthInsuranceQuoteLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmployerHealthInsuranceQuote|array The loaded EmployerHealthInsuranceQuote as an assoc-array at the
