...
class GroupQuoteIntentRequirementResponsePagedListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "group_quote_intent_requirement_response_paged_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GroupQuoteIntentRequirementResponsePagedListEntity($this->_client, $opts);
    }

    /**
     * @param GroupQuoteIntentRequirementResponsePagedList|array $args GroupQuoteIntentRequirementResponsePagedList data (assoc-array) to store.
     */
    ...
    /**
     * @return GroupQuoteIntentRequirementResponsePagedList|array The current GroupQuoteIntentRequirementResponsePagedList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GroupQuoteIntentRequirementResponsePagedList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GroupQuoteIntentRequirementResponsePagedList fields).
     */
    ...
    /**
     * List GroupQuoteIntentRequirementResponsePagedList items matching the given filter.
     *
     * @param GroupQuoteIntentRequirementResponsePagedListListMatch|array|null $reqmatch Match filter (any subset
     *   of GroupQuoteIntentRequirementResponsePagedList fields) as an assoc-array; GroupQuoteIntentRequirementResponsePagedListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupQuoteIntentRequirementResponsePagedList[]|array A list of GroupQuoteIntentRequirementResponsePagedList items as assoc-arrays at
