...
class EmployeeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EmployeeEntity($this->_client, $opts);
    }

    /**
     * @param Employee|array $args Employee data (assoc-array) to store.
     */
    ...
    /**
     * @return Employee|array The current Employee data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Employee fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Employee fields).
     */
     ...
     *
     * @param EmployeeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EmployeeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Employee|array The loaded Employee as an assoc-array at the
    ...
    /**
     * List Employee items matching the given filter.
     *
     * @param EmployeeListMatch|array|null $reqmatch Match filter (any subset
     *   of Employee fields) as an assoc-array; EmployeeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Employee[]|array A list of Employee items as assoc-arrays at
     ...
     *
     * @param EmployeeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmployeeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Employee|array The created Employee as an assoc-array at the
     *   SDK boundary; throws KotaError on failure (item-5 convention).
     */
     ...
     *
     * @param EmployeeUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmployeeUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Employee|array The updated Employee as an assoc-array at the
     *   SDK boundary; throws KotaError on failure (item-5 convention).
     */
