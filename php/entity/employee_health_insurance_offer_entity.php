...
class EmployeeHealthInsuranceOfferEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "employee_health_insurance_offer";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmployeeHealthInsuranceOfferEntity($this->_client, $opts);
    }

    /**
     * @param EmployeeHealthInsuranceOffer|array $args EmployeeHealthInsuranceOffer data (assoc-array) to store.
     */
    ...
    /**
     * @return EmployeeHealthInsuranceOffer|array The current EmployeeHealthInsuranceOffer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmployeeHealthInsuranceOffer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmployeeHealthInsuranceOffer fields).
     */
    ...
    /**
     * Load a single EmployeeHealthInsuranceOffer.
     *
     * @param EmployeeHealthInsuranceOfferLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EmployeeHealthInsuranceOfferLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmployeeHealthInsuranceOffer|array The loaded EmployeeHealthInsuranceOffer as an assoc-array at the
