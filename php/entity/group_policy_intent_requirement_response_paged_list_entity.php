...
class GroupPolicyIntentRequirementResponsePagedListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "group_policy_intent_requirement_response_paged_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GroupPolicyIntentRequirementResponsePagedListEntity($this->_client, $opts);
    }

    /**
     * @param GroupPolicyIntentRequirementResponsePagedList|array $args GroupPolicyIntentRequirementResponsePagedList data (assoc-array) to store.
     */
    ...
    /**
     * @return GroupPolicyIntentRequirementResponsePagedList|array The current GroupPolicyIntentRequirementResponsePagedList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GroupPolicyIntentRequirementResponsePagedList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GroupPolicyIntentRequirementResponsePagedList fields).
     */
    ...
    /**
     * List GroupPolicyIntentRequirementResponsePagedList items matching the given filter.
     *
     * @param GroupPolicyIntentRequirementResponsePagedListListMatch|array|null $reqmatch Match filter (any subset
     *   of GroupPolicyIntentRequirementResponsePagedList fields) as an assoc-array; GroupPolicyIntentRequirementResponsePagedListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupPolicyIntentRequirementResponsePagedList[]|array A list of GroupPolicyIntentRequirementResponsePagedList items as assoc-arrays at
