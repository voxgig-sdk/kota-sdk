...
class DependentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DependentEntity($this->_client, $opts);
    }

    /**
     * @param Dependent|array $args Dependent data (assoc-array) to store.
     */
    ...
    /**
     * @return Dependent|array The current Dependent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Dependent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Dependent fields).
     */
     ...
     *
     * @param DependentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DependentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dependent|array The created Dependent as an assoc-array at the
    ...
    /**
     * Remove an Dependent matching the given criteria.
     *
     * @param DependentRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DependentRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dependent|array The removed Dependent as an assoc-array at the
     *   SDK boundary; throws KotaError on failure (item-5 convention).
     */
