...
class GroupEmployeeResponsePagedListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "group_employee_response_paged_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GroupEmployeeResponsePagedListEntity($this->_client, $opts);
    }

    /**
     * @param GroupEmployeeResponsePagedList|array $args GroupEmployeeResponsePagedList data (assoc-array) to store.
     */
    ...
    /**
     * @return GroupEmployeeResponsePagedList|array The current GroupEmployeeResponsePagedList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GroupEmployeeResponsePagedList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GroupEmployeeResponsePagedList fields).
     */
    ...
    /**
     * List GroupEmployeeResponsePagedList items matching the given filter.
     *
     * @param GroupEmployeeResponsePagedListListMatch|array|null $reqmatch Match filter (any subset
     *   of GroupEmployeeResponsePagedList fields) as an assoc-array; GroupEmployeeResponsePagedListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupEmployeeResponsePagedList[]|array A list of GroupEmployeeResponsePagedList items as assoc-arrays at
