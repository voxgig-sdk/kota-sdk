...
class EmployerHealthInsuranceQuoteResponsePagedListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "employer_health_insurance_quote_response_paged_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmployerHealthInsuranceQuoteResponsePagedListEntity($this->_client, $opts);
    }

    /**
     * @param EmployerHealthInsuranceQuoteResponsePagedList|array $args EmployerHealthInsuranceQuoteResponsePagedList data (assoc-array) to store.
     */
    ...
    /**
     * @return EmployerHealthInsuranceQuoteResponsePagedList|array The current EmployerHealthInsuranceQuoteResponsePagedList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmployerHealthInsuranceQuoteResponsePagedList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmployerHealthInsuranceQuoteResponsePagedList fields).
     */
    ...
    /**
     * List EmployerHealthInsuranceQuoteResponsePagedList items matching the given filter.
     *
     * @param EmployerHealthInsuranceQuoteResponsePagedListListMatch|array|null $reqmatch Match filter (any subset
     *   of EmployerHealthInsuranceQuoteResponsePagedList fields) as an assoc-array; EmployerHealthInsuranceQuoteResponsePagedListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmployerHealthInsuranceQuoteResponsePagedList[]|array A list of EmployerHealthInsuranceQuoteResponsePagedList items as assoc-arrays at
