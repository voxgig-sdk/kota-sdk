...
class EmployeeHealthInsurancePolicyResponsePagedListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "employee_health_insurance_policy_response_paged_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmployeeHealthInsurancePolicyResponsePagedListEntity($this->_client, $opts);
    }

    /**
     * @param EmployeeHealthInsurancePolicyResponsePagedList|array $args EmployeeHealthInsurancePolicyResponsePagedList data (assoc-array) to store.
     */
    ...
    /**
     * @return EmployeeHealthInsurancePolicyResponsePagedList|array The current EmployeeHealthInsurancePolicyResponsePagedList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmployeeHealthInsurancePolicyResponsePagedList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmployeeHealthInsurancePolicyResponsePagedList fields).
     */
    ...
    /**
     * List EmployeeHealthInsurancePolicyResponsePagedList items matching the given filter.
     *
     * @param EmployeeHealthInsurancePolicyResponsePagedListListMatch|array|null $reqmatch Match filter (any subset
     *   of EmployeeHealthInsurancePolicyResponsePagedList fields) as an assoc-array; EmployeeHealthInsurancePolicyResponsePagedListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmployeeHealthInsurancePolicyResponsePagedList[]|array A list of EmployeeHealthInsurancePolicyResponsePagedList items as assoc-arrays at
