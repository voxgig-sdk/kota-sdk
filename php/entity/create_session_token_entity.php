...
// Kota SDK CreateSessionToken entity
...
class CreateSessionTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "create_session_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CreateSessionTokenEntity($this->_client, $opts);
    }

    /**
     * @param CreateSessionToken|array $args CreateSessionToken data (assoc-array) to store.
     */
    ...
    /**
     * @return CreateSessionToken|array The current CreateSessionToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CreateSessionToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CreateSessionToken fields).
     */
    ...
    /**
     * Create a new CreateSessionToken.
     *
     * @param CreateSessionTokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CreateSessionTokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CreateSessionToken|array The created CreateSessionToken as an assoc-array at the
