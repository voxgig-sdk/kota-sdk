...
class ContributionReportEmployeeBreakdownResponsePagedListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "contribution_report_employee_breakdown_response_paged_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ContributionReportEmployeeBreakdownResponsePagedListEntity($this->_client, $opts);
    }

    /**
     * @param ContributionReportEmployeeBreakdownResponsePagedList|array $args ContributionReportEmployeeBreakdownResponsePagedList data (assoc-array) to store.
     */
    ...
    /**
     * @return ContributionReportEmployeeBreakdownResponsePagedList|array The current ContributionReportEmployeeBreakdownResponsePagedList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ContributionReportEmployeeBreakdownResponsePagedList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ContributionReportEmployeeBreakdownResponsePagedList fields).
     */
    ...
    /**
     * List ContributionReportEmployeeBreakdownResponsePagedList items matching the given filter.
     *
     * @param ContributionReportEmployeeBreakdownResponsePagedListListMatch|array|null $reqmatch Match filter (any subset
     *   of ContributionReportEmployeeBreakdownResponsePagedList fields) as an assoc-array; ContributionReportEmployeeBreakdownResponsePagedListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContributionReportEmployeeBreakdownResponsePagedList[]|array A list of ContributionReportEmployeeBreakdownResponsePagedList items as assoc-arrays at
