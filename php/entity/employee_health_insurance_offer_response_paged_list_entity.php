...
class EmployeeHealthInsuranceOfferResponsePagedListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "employee_health_insurance_offer_response_paged_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmployeeHealthInsuranceOfferResponsePagedListEntity($this->_client, $opts);
    }

    /**
     * @param EmployeeHealthInsuranceOfferResponsePagedList|array $args EmployeeHealthInsuranceOfferResponsePagedList data (assoc-array) to store.
     */
    ...
    /**
     * @return EmployeeHealthInsuranceOfferResponsePagedList|array The current EmployeeHealthInsuranceOfferResponsePagedList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmployeeHealthInsuranceOfferResponsePagedList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmployeeHealthInsuranceOfferResponsePagedList fields).
     */
    ...
    /**
     * List EmployeeHealthInsuranceOfferResponsePagedList items matching the given filter.
     *
     * @param EmployeeHealthInsuranceOfferResponsePagedListListMatch|array|null $reqmatch Match filter (any subset
     *   of EmployeeHealthInsuranceOfferResponsePagedList fields) as an assoc-array; EmployeeHealthInsuranceOfferResponsePagedListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmployeeHealthInsuranceOfferResponsePagedList[]|array A list of EmployeeHealthInsuranceOfferResponsePagedList items as assoc-arrays at
