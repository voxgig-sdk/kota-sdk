...
class EnrolmentIntentRequirementResponsePagedListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "enrolment_intent_requirement_response_paged_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EnrolmentIntentRequirementResponsePagedListEntity($this->_client, $opts);
    }

    /**
     * @param EnrolmentIntentRequirementResponsePagedList|array $args EnrolmentIntentRequirementResponsePagedList data (assoc-array) to store.
     */
    ...
    /**
     * @return EnrolmentIntentRequirementResponsePagedList|array The current EnrolmentIntentRequirementResponsePagedList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EnrolmentIntentRequirementResponsePagedList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EnrolmentIntentRequirementResponsePagedList fields).
     */
    ...
    /**
     * List EnrolmentIntentRequirementResponsePagedList items matching the given filter.
     *
     * @param EnrolmentIntentRequirementResponsePagedListListMatch|array|null $reqmatch Match filter (any subset
     *   of EnrolmentIntentRequirementResponsePagedList fields) as an assoc-array; EnrolmentIntentRequirementResponsePagedListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnrolmentIntentRequirementResponsePagedList[]|array A list of EnrolmentIntentRequirementResponsePagedList items as assoc-arrays at
