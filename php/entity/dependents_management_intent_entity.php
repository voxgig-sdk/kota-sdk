...
// Kota SDK DependentsManagementIntent entity
...
class DependentsManagementIntentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "dependents_management_intent";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DependentsManagementIntentEntity($this->_client, $opts);
    }

    /**
     * @param DependentsManagementIntent|array $args DependentsManagementIntent data (assoc-array) to store.
     */
    ...
    /**
     * @return DependentsManagementIntent|array The current DependentsManagementIntent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DependentsManagementIntent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DependentsManagementIntent fields).
     */
    ...
    /**
     * Load a single DependentsManagementIntent.
     *
     * @param DependentsManagementIntentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DependentsManagementIntentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DependentsManagementIntent|array The loaded DependentsManagementIntent as an assoc-array at the
    ...
    /**
     * Create a new DependentsManagementIntent.
     *
     * @param DependentsManagementIntentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DependentsManagementIntentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DependentsManagementIntent|array The created DependentsManagementIntent as an assoc-array at the
     *   SDK boundary; throws KotaError on failure (item-5 convention).
     */
