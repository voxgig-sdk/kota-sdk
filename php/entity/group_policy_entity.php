...
class GroupPolicyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GroupPolicyEntity($this->_client, $opts);
    }

    /**
     * @param GroupPolicy|array $args GroupPolicy data (assoc-array) to store.
     */
    ...
    /**
     * @return GroupPolicy|array The current GroupPolicy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GroupPolicy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GroupPolicy fields).
     */
    ...
    /**
     * Load a single GroupPolicy.
     *
     * @param GroupPolicyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GroupPolicyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupPolicy|array The loaded GroupPolicy as an assoc-array at the
    ...
    /**
     * List GroupPolicy items matching the given filter.
     *
     * @param GroupPolicyListMatch|array|null $reqmatch Match filter (any subset
     *   of GroupPolicy fields) as an assoc-array; GroupPolicyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupPolicy[]|array A list of GroupPolicy items as assoc-arrays at
