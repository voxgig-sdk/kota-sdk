...
class CreateHostedSessionTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "create_hosted_session_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CreateHostedSessionTokenEntity($this->_client, $opts);
    }

    /**
     * @param CreateHostedSessionToken|array $args CreateHostedSessionToken data (assoc-array) to store.
     */
    ...
    /**
     * @return CreateHostedSessionToken|array The current CreateHostedSessionToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CreateHostedSessionToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CreateHostedSessionToken fields).
     */
    ...
    /**
     * Create a new CreateHostedSessionToken.
     *
     * @param CreateHostedSessionTokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CreateHostedSessionTokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CreateHostedSessionToken|array The created CreateHostedSessionToken as an assoc-array at the
