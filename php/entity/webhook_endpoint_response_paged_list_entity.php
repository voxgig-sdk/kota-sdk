...
class WebhookEndpointResponsePagedListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "webhook_endpoint_response_paged_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new WebhookEndpointResponsePagedListEntity($this->_client, $opts);
    }

    /**
     * @param WebhookEndpointResponsePagedList|array $args WebhookEndpointResponsePagedList data (assoc-array) to store.
     */
    ...
    /**
     * @return WebhookEndpointResponsePagedList|array The current WebhookEndpointResponsePagedList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebhookEndpointResponsePagedList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebhookEndpointResponsePagedList fields).
     */
    ...
    /**
     * List WebhookEndpointResponsePagedList items matching the given filter.
     *
     * @param WebhookEndpointResponsePagedListListMatch|array|null $reqmatch Match filter (any subset
     *   of WebhookEndpointResponsePagedList fields) as an assoc-array; WebhookEndpointResponsePagedListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhookEndpointResponsePagedList[]|array A list of WebhookEndpointResponsePagedList items as assoc-arrays at
