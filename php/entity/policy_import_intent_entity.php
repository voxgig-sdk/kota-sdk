...
// Kota SDK PolicyImportIntent entity
...
class PolicyImportIntentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "policy_import_intent";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PolicyImportIntentEntity($this->_client, $opts);
    }

    /**
     * @param PolicyImportIntent|array $args PolicyImportIntent data (assoc-array) to store.
     */
    ...
    /**
     * @return PolicyImportIntent|array The current PolicyImportIntent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PolicyImportIntent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PolicyImportIntent fields).
     */
    ...
    /**
     * Load a single PolicyImportIntent.
     *
     * @param PolicyImportIntentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PolicyImportIntentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PolicyImportIntent|array The loaded PolicyImportIntent as an assoc-array at the
    ...
    /**
     * List PolicyImportIntent items matching the given filter.
     *
     * @param PolicyImportIntentListMatch|array|null $reqmatch Match filter (any subset
     *   of PolicyImportIntent fields) as an assoc-array; PolicyImportIntentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PolicyImportIntent[]|array A list of PolicyImportIntent items as assoc-arrays at
    ...
    /**
     * Create a new PolicyImportIntent.
     *
     * @param PolicyImportIntentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PolicyImportIntentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PolicyImportIntent|array The created PolicyImportIntent as an assoc-array at the
     *   SDK boundary; throws KotaError on failure (item-5 convention).
     */
