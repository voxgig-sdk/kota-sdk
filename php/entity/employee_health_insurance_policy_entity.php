...
class EmployeeHealthInsurancePolicyEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "employee_health_insurance_policy";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmployeeHealthInsurancePolicyEntity($this->_client, $opts);
    }

    /**
     * @param EmployeeHealthInsurancePolicy|array $args EmployeeHealthInsurancePolicy data (assoc-array) to store.
     */
    ...
    /**
     * @return EmployeeHealthInsurancePolicy|array The current EmployeeHealthInsurancePolicy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmployeeHealthInsurancePolicy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmployeeHealthInsurancePolicy fields).
     */
    ...
    /**
     * Load a single EmployeeHealthInsurancePolicy.
     *
     * @param EmployeeHealthInsurancePolicyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EmployeeHealthInsurancePolicyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmployeeHealthInsurancePolicy|array The loaded EmployeeHealthInsurancePolicy as an assoc-array at the
