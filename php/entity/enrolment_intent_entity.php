...
// Kota SDK EnrolmentIntent entity
...
class EnrolmentIntentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EnrolmentIntentEntity($this->_client, $opts);
    }

    /**
     * @param EnrolmentIntent|array $args EnrolmentIntent data (assoc-array) to store.
     */
    ...
    /**
     * @return EnrolmentIntent|array The current EnrolmentIntent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EnrolmentIntent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EnrolmentIntent fields).
     */
    ...
    /**
     * Load a single EnrolmentIntent.
     *
     * @param EnrolmentIntentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EnrolmentIntentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnrolmentIntent|array The loaded EnrolmentIntent as an assoc-array at the
    ...
    /**
     * List EnrolmentIntent items matching the given filter.
     *
     * @param EnrolmentIntentListMatch|array|null $reqmatch Match filter (any subset
     *   of EnrolmentIntent fields) as an assoc-array; EnrolmentIntentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnrolmentIntent[]|array A list of EnrolmentIntent items as assoc-arrays at
    ...
    /**
     * Create a new EnrolmentIntent.
     *
     * @param EnrolmentIntentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EnrolmentIntentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnrolmentIntent|array The created EnrolmentIntent as an assoc-array at the
     *   SDK boundary; throws KotaError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing EnrolmentIntent.
     *
     * @param EnrolmentIntentUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EnrolmentIntentUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnrolmentIntent|array The updated EnrolmentIntent as an assoc-array at the
     *   SDK boundary; throws KotaError on failure (item-5 convention).
     */
