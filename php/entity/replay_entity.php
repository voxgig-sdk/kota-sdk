...
class ReplayEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReplayEntity($this->_client, $opts);
    }

    /**
     * @param Replay|array $args Replay data (assoc-array) to store.
     */
    ...
    /**
     * @return Replay|array The current Replay data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Replay fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Replay fields).
     */
     ...
     * Create a new Replay.
     *
     * @param ReplayCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReplayCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Replay|array The created Replay as an assoc-array at the
