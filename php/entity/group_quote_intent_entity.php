...
// Kota SDK GroupQuoteIntent entity
...
class GroupQuoteIntentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GroupQuoteIntentEntity($this->_client, $opts);
    }

    /**
     * @param GroupQuoteIntent|array $args GroupQuoteIntent data (assoc-array) to store.
     */
    ...
    /**
     * @return GroupQuoteIntent|array The current GroupQuoteIntent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GroupQuoteIntent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GroupQuoteIntent fields).
     */
    ...
    /**
     * Load a single GroupQuoteIntent.
     *
     * @param GroupQuoteIntentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GroupQuoteIntentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupQuoteIntent|array The loaded GroupQuoteIntent as an assoc-array at the
    ...
    /**
     * List GroupQuoteIntent items matching the given filter.
     *
     * @param GroupQuoteIntentListMatch|array|null $reqmatch Match filter (any subset
     *   of GroupQuoteIntent fields) as an assoc-array; GroupQuoteIntentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupQuoteIntent[]|array A list of GroupQuoteIntent items as assoc-arrays at
    ...
    /**
     * Create a new GroupQuoteIntent.
     *
     * @param GroupQuoteIntentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GroupQuoteIntentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupQuoteIntent|array The created GroupQuoteIntent as an assoc-array at the
     *   SDK boundary; throws KotaError on failure (item-5 convention).
     */
