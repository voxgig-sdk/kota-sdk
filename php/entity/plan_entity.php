...
class PlanEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PlanEntity($this->_client, $opts);
    }

    /**
     * @param Plan|array $args Plan data (assoc-array) to store.
     */
    ...
    /**
     * @return Plan|array The current Plan data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Plan fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Plan fields).
     */
     ...
     * Load a single Plan.
     *
     * @param PlanLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PlanLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Plan|array The loaded Plan as an assoc-array at the
    ...
    /**
     * List Plan items matching the given filter.
     *
     * @param PlanListMatch|array|null $reqmatch Match filter (any subset
     *   of Plan fields) as an assoc-array; PlanListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Plan[]|array A list of Plan items as assoc-arrays at
