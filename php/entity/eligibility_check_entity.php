...
// Kota SDK EligibilityCheck entity
...
class EligibilityCheckEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EligibilityCheckEntity($this->_client, $opts);
    }

    /**
     * @param EligibilityCheck|array $args EligibilityCheck data (assoc-array) to store.
     */
    ...
    /**
     * @return EligibilityCheck|array The current EligibilityCheck data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EligibilityCheck fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EligibilityCheck fields).
     */
    ...
    /**
     * Create a new EligibilityCheck.
     *
     * @param EligibilityCheckCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EligibilityCheckCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EligibilityCheck|array The created EligibilityCheck as an assoc-array at the
