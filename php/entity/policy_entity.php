...
class PolicyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PolicyEntity($this->_client, $opts);
    }

    /**
     * @param Policy|array $args Policy data (assoc-array) to store.
     */
    ...
    /**
     * @return Policy|array The current Policy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Policy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Policy fields).
     */
     ...
     *
     * @param PolicyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PolicyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Policy|array The loaded Policy as an assoc-array at the
    ...
    /**
     * List Policy items matching the given filter.
     *
     * @param PolicyListMatch|array|null $reqmatch Match filter (any subset
     *   of Policy fields) as an assoc-array; PolicyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Policy[]|array A list of Policy items as assoc-arrays at
