...
// Kota SDK ContributionReport entity
...
class ContributionReportEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "contribution_report";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ContributionReportEntity($this->_client, $opts);
    }

    /**
     * @param ContributionReport|array $args ContributionReport data (assoc-array) to store.
     */
    ...
    /**
     * @return ContributionReport|array The current ContributionReport data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ContributionReport fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ContributionReport fields).
     */
    ...
    /**
     * Load a single ContributionReport.
     *
     * @param ContributionReportLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ContributionReportLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContributionReport|array The loaded ContributionReport as an assoc-array at the
    ...
    /**
     * List ContributionReport items matching the given filter.
     *
     * @param ContributionReportListMatch|array|null $reqmatch Match filter (any subset
     *   of ContributionReport fields) as an assoc-array; ContributionReportListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContributionReport[]|array A list of ContributionReport items as assoc-arrays at
    ...
    /**
     * Create a new ContributionReport.
     *
     * @param ContributionReportCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ContributionReportCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContributionReport|array The created ContributionReport as an assoc-array at the
     *   SDK boundary; throws KotaError on failure (item-5 convention).
     */
