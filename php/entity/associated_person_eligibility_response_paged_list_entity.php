...
class AssociatedPersonEligibilityResponsePagedListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "associated_person_eligibility_response_paged_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AssociatedPersonEligibilityResponsePagedListEntity($this->_client, $opts);
    }

    /**
     * @param AssociatedPersonEligibilityResponsePagedList|array $args AssociatedPersonEligibilityResponsePagedList data (assoc-array) to store.
     */
    ...
    /**
     * @return AssociatedPersonEligibilityResponsePagedList|array The current AssociatedPersonEligibilityResponsePagedList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AssociatedPersonEligibilityResponsePagedList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AssociatedPersonEligibilityResponsePagedList fields).
     */
    ...
    /**
     * List AssociatedPersonEligibilityResponsePagedList items matching the given filter.
     *
     * @param AssociatedPersonEligibilityResponsePagedListListMatch|array|null $reqmatch Match filter (any subset
     *   of AssociatedPersonEligibilityResponsePagedList fields) as an assoc-array; AssociatedPersonEligibilityResponsePagedListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AssociatedPersonEligibilityResponsePagedList[]|array A list of AssociatedPersonEligibilityResponsePagedList items as assoc-arrays at
