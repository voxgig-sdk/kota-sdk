...
class EmployerHealthInsurancePolicyResponsePagedListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "employer_health_insurance_policy_response_paged_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmployerHealthInsurancePolicyResponsePagedListEntity($this->_client, $opts);
    }

    /**
     * @param EmployerHealthInsurancePolicyResponsePagedList|array $args EmployerHealthInsurancePolicyResponsePagedList data (assoc-array) to store.
     */
    ...
    /**
     * @return EmployerHealthInsurancePolicyResponsePagedList|array The current EmployerHealthInsurancePolicyResponsePagedList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmployerHealthInsurancePolicyResponsePagedList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmployerHealthInsurancePolicyResponsePagedList fields).
     */
    ...
    /**
     * List EmployerHealthInsurancePolicyResponsePagedList items matching the given filter.
     *
     * @param EmployerHealthInsurancePolicyResponsePagedListListMatch|array|null $reqmatch Match filter (any subset
     *   of EmployerHealthInsurancePolicyResponsePagedList fields) as an assoc-array; EmployerHealthInsurancePolicyResponsePagedListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmployerHealthInsurancePolicyResponsePagedList[]|array A list of EmployerHealthInsurancePolicyResponsePagedList items as assoc-arrays at
