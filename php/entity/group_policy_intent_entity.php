...
// Kota SDK GroupPolicyIntent entity
...
class GroupPolicyIntentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "group_policy_intent";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GroupPolicyIntentEntity($this->_client, $opts);
    }

    /**
     * @param GroupPolicyIntent|array $args GroupPolicyIntent data (assoc-array) to store.
     */
    ...
    /**
     * @return GroupPolicyIntent|array The current GroupPolicyIntent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GroupPolicyIntent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GroupPolicyIntent fields).
     */
    ...
    /**
     * Load a single GroupPolicyIntent.
     *
     * @param GroupPolicyIntentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GroupPolicyIntentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupPolicyIntent|array The loaded GroupPolicyIntent as an assoc-array at the
    ...
    /**
     * List GroupPolicyIntent items matching the given filter.
     *
     * @param GroupPolicyIntentListMatch|array|null $reqmatch Match filter (any subset
     *   of GroupPolicyIntent fields) as an assoc-array; GroupPolicyIntentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupPolicyIntent[]|array A list of GroupPolicyIntent items as assoc-arrays at
    ...
    /**
     * Create a new GroupPolicyIntent.
     *
     * @param GroupPolicyIntentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GroupPolicyIntentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupPolicyIntent|array The created GroupPolicyIntent as an assoc-array at the
     *   SDK boundary; throws KotaError on failure (item-5 convention).
     */
