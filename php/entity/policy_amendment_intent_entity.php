...
// Kota SDK PolicyAmendmentIntent entity
...
class PolicyAmendmentIntentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "policy_amendment_intent";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PolicyAmendmentIntentEntity($this->_client, $opts);
    }

    /**
     * @param PolicyAmendmentIntent|array $args PolicyAmendmentIntent data (assoc-array) to store.
     */
    ...
    /**
     * @return PolicyAmendmentIntent|array The current PolicyAmendmentIntent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PolicyAmendmentIntent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PolicyAmendmentIntent fields).
     */
    ...
    /**
     * Load a single PolicyAmendmentIntent.
     *
     * @param PolicyAmendmentIntentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PolicyAmendmentIntentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PolicyAmendmentIntent|array The loaded PolicyAmendmentIntent as an assoc-array at the
    ...
    /**
     * List PolicyAmendmentIntent items matching the given filter.
     *
     * @param PolicyAmendmentIntentListMatch|array|null $reqmatch Match filter (any subset
     *   of PolicyAmendmentIntent fields) as an assoc-array; PolicyAmendmentIntentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PolicyAmendmentIntent[]|array A list of PolicyAmendmentIntent items as assoc-arrays at
    ...
    /**
     * Create a new PolicyAmendmentIntent.
     *
     * @param PolicyAmendmentIntentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PolicyAmendmentIntentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PolicyAmendmentIntent|array The created PolicyAmendmentIntent as an assoc-array at the
     *   SDK boundary; throws KotaError on failure (item-5 convention).
     */
