...
class GroupEmployeeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GroupEmployeeEntity($this->_client, $opts);
    }

    /**
     * @param GroupEmployee|array $args GroupEmployee data (assoc-array) to store.
     */
    ...
    /**
     * @return GroupEmployee|array The current GroupEmployee data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GroupEmployee fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GroupEmployee fields).
     */
    ...
    /**
     * Create a new GroupEmployee.
     *
     * @param GroupEmployeeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GroupEmployeeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupEmployee|array The created GroupEmployee as an assoc-array at the
