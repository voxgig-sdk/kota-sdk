...
class GroupQuoteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GroupQuoteEntity($this->_client, $opts);
    }

    /**
     * @param GroupQuote|array $args GroupQuote data (assoc-array) to store.
     */
    ...
    /**
     * @return GroupQuote|array The current GroupQuote data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GroupQuote fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GroupQuote fields).
     */
    ...
    /**
     * Load a single GroupQuote.
     *
     * @param GroupQuoteLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GroupQuoteLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupQuote|array The loaded GroupQuote as an assoc-array at the
