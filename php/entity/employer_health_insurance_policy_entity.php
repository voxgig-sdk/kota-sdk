...
class EmployerHealthInsurancePolicyEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "employer_health_insurance_policy";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmployerHealthInsurancePolicyEntity($this->_client, $opts);
    }

    /**
     * @param EmployerHealthInsurancePolicy|array $args EmployerHealthInsurancePolicy data (assoc-array) to store.
     */
    ...
    /**
     * @return EmployerHealthInsurancePolicy|array The current EmployerHealthInsurancePolicy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmployerHealthInsurancePolicy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmployerHealthInsurancePolicy fields).
     */
    ...
    /**
     * Load a single EmployerHealthInsurancePolicy.
     *
     * @param EmployerHealthInsurancePolicyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EmployerHealthInsurancePolicyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmployerHealthInsurancePolicy|array The loaded EmployerHealthInsurancePolicy as an assoc-array at the
