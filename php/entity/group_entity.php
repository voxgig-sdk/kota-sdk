...
class GroupEntity
{
     ...
     * Load a single Group.
     *
     * @param GroupLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GroupLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Group|array The loaded Group as an assoc-array at the
     ...
     *
     * @param GroupListMatch|array|null $reqmatch Match filter (any subset
     *   of Group fields) as an assoc-array; GroupListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Group[]|array A list of Group items as assoc-arrays at
     ...
     *
     * @param GroupUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GroupUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Group|array The updated Group as an assoc-array at the
     *   SDK boundary; throws KotaError on failure (item-5 convention).
     */
