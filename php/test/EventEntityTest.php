...
class EventEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set KOTA_TEST_EVENT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function event_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("KOTA_TEST_EVENT_ENTID");
