...
class KotaTestRunner
{
    ...
    {
        $live = self::getenv('KOTA_TEST_LIVE');
        $override = self::getenv('KOTA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('KOTA_TEST_EXPLAIN');
...
class_alias('KotaTestRunner', 'Runner');
class_alias('KotaHelpers', 'Helpers');
