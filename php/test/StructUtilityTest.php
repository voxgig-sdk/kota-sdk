...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KotaOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KotaOmni::structfix($now, Struct::undef()))
                        !== json_encode(KotaOmni::structfix($val, Struct::undef()))) {
