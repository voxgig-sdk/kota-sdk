...
// Kota SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KotaSDK::test)
...
{
    private const SDK_CLASS = 'KotaSDK';
    ...
    private const SDK_BASE = 'kota_sdk';
