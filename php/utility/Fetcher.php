...
class KotaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KotaSDK/1.0)';
    ...
    public static function call(KotaContext $ctx, string $fullurl, array $fetchdef): array
    {
