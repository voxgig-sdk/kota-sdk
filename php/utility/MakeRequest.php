...
// Kota SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class KotaMakeRequest
{
    public static function call(KotaContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new KotaResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new KotaResponse($fetched);
        } else {
