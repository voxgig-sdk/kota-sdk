...
class KotaCacheFeature extends KotaBaseFeature
{
    ...
    private function _through(KotaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
