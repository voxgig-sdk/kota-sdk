...
class KotaStreamingFeature extends KotaBaseFeature
{
    ...
    private function _iterate(KotaResult $result): \Generator
    {
    ...
    private function _streamable(KotaContext $ctx): bool
    {
