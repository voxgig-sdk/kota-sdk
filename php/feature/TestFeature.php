...
// Kota SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KotaTestFeature extends KotaBaseFeature
{
    ...
    public function init(KotaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KotaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KotaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KotaContext $ctx, $op, $args): array
    {
