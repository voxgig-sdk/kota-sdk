...
class KotaRbacFeature extends KotaBaseFeature
{
    ...
    private function _required(KotaContext $ctx): ?string
    {
    ...
    private function _reject(KotaContext $ctx, string $required): void
    {
    ...
    private function _track(KotaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
