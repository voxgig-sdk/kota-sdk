...
class KotaRatelimitFeature extends KotaBaseFeature
{
    ...
    private function _acquire(KotaContext $ctx): void
    {
    ...
    private function _track(KotaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
