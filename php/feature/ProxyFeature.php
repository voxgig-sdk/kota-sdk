...
class KotaProxyFeature extends KotaBaseFeature
{
    ...
    public function init(KotaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KotaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
