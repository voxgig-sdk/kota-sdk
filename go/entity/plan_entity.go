...
func NewPlanEntity(client *core.KotaSDK, entopts map[string]any) *PlanEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PlanEntity) GetName() string { return e.name }
...
func (e *PlanEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PlanEntity) Deleted() bool {
	return e.deleted
}


func (e *PlanEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPlanEntity(e.client, opts)
}

func (e *PlanEntity) Data(args ...any) any {
...
func (e *PlanEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Plan; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PlanEntity) DataTyped(data ...Plan) Plan {
	if len(data) > 0 {
		return typedFrom[Plan](e.Data(asMap(data[0])))
	}
	return typedFrom[Plan](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Plan (all fields
// optional at the wire level).
func (e *PlanEntity) MatchTyped(match ...Plan) Plan {
	if len(match) > 0 {
		return typedFrom[Plan](e.Match(asMap(match[0])))
	}
	return typedFrom[Plan](e.Match())
}
...
func (e *PlanEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PlanEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PlanLoadMatch and returns an Plan. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PlanEntity) LoadTyped(reqmatch PlanLoadMatch, ctrl map[string]any) (Plan, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Plan{}, err
	}
	return typedFrom[Plan](res), nil
}




func (e *PlanEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PlanListMatch and returns []Plan. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PlanEntity) ListTyped(reqmatch PlanListMatch, ctrl map[string]any) ([]Plan, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Plan](res), nil
}



func (e *PlanEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PlanEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PlanEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PlanEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
