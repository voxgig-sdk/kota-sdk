...
func NewGroupQuoteEntity(client *core.KotaSDK, entopts map[string]any) *GroupQuoteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GroupQuoteEntity) GetName() string { return e.name }
...
func (e *GroupQuoteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GroupQuoteEntity) Deleted() bool {
	return e.deleted
}


func (e *GroupQuoteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGroupQuoteEntity(e.client, opts)
}

func (e *GroupQuoteEntity) Data(args ...any) any {
...
func (e *GroupQuoteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GroupQuote; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GroupQuoteEntity) DataTyped(data ...GroupQuote) GroupQuote {
	if len(data) > 0 {
		return typedFrom[GroupQuote](e.Data(asMap(data[0])))
	}
	return typedFrom[GroupQuote](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GroupQuote (all fields
// optional at the wire level).
func (e *GroupQuoteEntity) MatchTyped(match ...GroupQuote) GroupQuote {
	if len(match) > 0 {
		return typedFrom[GroupQuote](e.Match(asMap(match[0])))
	}
	return typedFrom[GroupQuote](e.Match())
}
...
func (e *GroupQuoteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GroupQuoteEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GroupQuoteLoadMatch and returns an GroupQuote. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GroupQuoteEntity) LoadTyped(reqmatch GroupQuoteLoadMatch, ctrl map[string]any) (GroupQuote, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GroupQuote{}, err
	}
	return typedFrom[GroupQuote](res), nil
}



func (e *GroupQuoteEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GroupQuoteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GroupQuoteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GroupQuoteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GroupQuoteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
