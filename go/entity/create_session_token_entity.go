...
type CreateSessionTokenEntity struct {
	name    string
	client  *core.KotaSDK
...
func NewCreateSessionTokenEntity(client *core.KotaSDK, entopts map[string]any) *CreateSessionTokenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CreateSessionTokenEntity) GetName() string { return e.name }
...
func (e *CreateSessionTokenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CreateSessionTokenEntity) Deleted() bool {
	return e.deleted
}


func (e *CreateSessionTokenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCreateSessionTokenEntity(e.client, opts)
}

func (e *CreateSessionTokenEntity) Data(args ...any) any {
...
func (e *CreateSessionTokenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CreateSessionToken; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CreateSessionTokenEntity) DataTyped(data ...CreateSessionToken) CreateSessionToken {
	if len(data) > 0 {
		return typedFrom[CreateSessionToken](e.Data(asMap(data[0])))
	}
	return typedFrom[CreateSessionToken](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CreateSessionToken (all fields
// optional at the wire level).
func (e *CreateSessionTokenEntity) MatchTyped(match ...CreateSessionToken) CreateSessionToken {
	if len(match) > 0 {
		return typedFrom[CreateSessionToken](e.Match(asMap(match[0])))
	}
	return typedFrom[CreateSessionToken](e.Match())
}
...
func (e *CreateSessionTokenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CreateSessionTokenEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CreateSessionTokenEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CreateSessionTokenEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CreateSessionTokenCreateData and returns an CreateSessionToken. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CreateSessionTokenEntity) CreateTyped(reqdata CreateSessionTokenCreateData, ctrl map[string]any) (CreateSessionToken, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return CreateSessionToken{}, err
	}
	return typedFrom[CreateSessionToken](res), nil
}



func (e *CreateSessionTokenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CreateSessionTokenEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CreateSessionTokenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
