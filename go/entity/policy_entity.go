...
func NewPolicyEntity(client *core.KotaSDK, entopts map[string]any) *PolicyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PolicyEntity) GetName() string { return e.name }
...
func (e *PolicyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PolicyEntity) Deleted() bool {
	return e.deleted
}


func (e *PolicyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPolicyEntity(e.client, opts)
}

func (e *PolicyEntity) Data(args ...any) any {
...
func (e *PolicyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Policy; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PolicyEntity) DataTyped(data ...Policy) Policy {
	if len(data) > 0 {
		return typedFrom[Policy](e.Data(asMap(data[0])))
	}
	return typedFrom[Policy](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Policy (all fields
// optional at the wire level).
func (e *PolicyEntity) MatchTyped(match ...Policy) Policy {
	if len(match) > 0 {
		return typedFrom[Policy](e.Match(asMap(match[0])))
	}
	return typedFrom[Policy](e.Match())
}
...
func (e *PolicyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PolicyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PolicyLoadMatch and returns an Policy. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PolicyEntity) LoadTyped(reqmatch PolicyLoadMatch, ctrl map[string]any) (Policy, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Policy{}, err
	}
	return typedFrom[Policy](res), nil
}




func (e *PolicyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PolicyListMatch and returns []Policy. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PolicyEntity) ListTyped(reqmatch PolicyListMatch, ctrl map[string]any) ([]Policy, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Policy](res), nil
}



func (e *PolicyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PolicyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PolicyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PolicyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
