...
type GroupEmployeeEntity struct {
	name    string
	client  *core.KotaSDK
...
func NewGroupEmployeeEntity(client *core.KotaSDK, entopts map[string]any) *GroupEmployeeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GroupEmployeeEntity) GetName() string { return e.name }
...
func (e *GroupEmployeeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GroupEmployeeEntity) Deleted() bool {
	return e.deleted
}


func (e *GroupEmployeeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGroupEmployeeEntity(e.client, opts)
}

func (e *GroupEmployeeEntity) Data(args ...any) any {
...
func (e *GroupEmployeeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GroupEmployee; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GroupEmployeeEntity) DataTyped(data ...GroupEmployee) GroupEmployee {
	if len(data) > 0 {
		return typedFrom[GroupEmployee](e.Data(asMap(data[0])))
	}
	return typedFrom[GroupEmployee](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GroupEmployee (all fields
// optional at the wire level).
func (e *GroupEmployeeEntity) MatchTyped(match ...GroupEmployee) GroupEmployee {
	if len(match) > 0 {
		return typedFrom[GroupEmployee](e.Match(asMap(match[0])))
	}
	return typedFrom[GroupEmployee](e.Match())
}
...
func (e *GroupEmployeeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GroupEmployeeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *GroupEmployeeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GroupEmployeeEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GroupEmployeeCreateData and returns an GroupEmployee. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GroupEmployeeEntity) CreateTyped(reqdata GroupEmployeeCreateData, ctrl map[string]any) (GroupEmployee, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return GroupEmployee{}, err
	}
	return typedFrom[GroupEmployee](res), nil
}



func (e *GroupEmployeeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GroupEmployeeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GroupEmployeeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
