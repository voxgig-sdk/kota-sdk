...
func NewDependentEntity(client *core.KotaSDK, entopts map[string]any) *DependentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DependentEntity) GetName() string { return e.name }
...
func (e *DependentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DependentEntity) Deleted() bool {
	return e.deleted
}


func (e *DependentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDependentEntity(e.client, opts)
}

func (e *DependentEntity) Data(args ...any) any {
...
func (e *DependentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Dependent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DependentEntity) DataTyped(data ...Dependent) Dependent {
	if len(data) > 0 {
		return typedFrom[Dependent](e.Data(asMap(data[0])))
	}
	return typedFrom[Dependent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Dependent (all fields
// optional at the wire level).
func (e *DependentEntity) MatchTyped(match ...Dependent) Dependent {
	if len(match) > 0 {
		return typedFrom[Dependent](e.Match(asMap(match[0])))
	}
	return typedFrom[Dependent](e.Match())
}
...
func (e *DependentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DependentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DependentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DependentEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DependentCreateData and returns an Dependent. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DependentEntity) CreateTyped(reqdata DependentCreateData, ctrl map[string]any) (Dependent, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Dependent{}, err
	}
	return typedFrom[Dependent](res), nil
}



func (e *DependentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *DependentEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// DependentRemoveMatch and returns an Dependent. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *DependentEntity) RemoveTyped(reqmatch DependentRemoveMatch, ctrl map[string]any) (Dependent, error) {
...
func (e *DependentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
