...
func NewGroupPolicyEntity(client *core.KotaSDK, entopts map[string]any) *GroupPolicyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GroupPolicyEntity) GetName() string { return e.name }
...
func (e *GroupPolicyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GroupPolicyEntity) Deleted() bool {
	return e.deleted
}


func (e *GroupPolicyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGroupPolicyEntity(e.client, opts)
}

func (e *GroupPolicyEntity) Data(args ...any) any {
...
func (e *GroupPolicyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GroupPolicy; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GroupPolicyEntity) DataTyped(data ...GroupPolicy) GroupPolicy {
	if len(data) > 0 {
		return typedFrom[GroupPolicy](e.Data(asMap(data[0])))
	}
	return typedFrom[GroupPolicy](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GroupPolicy (all fields
// optional at the wire level).
func (e *GroupPolicyEntity) MatchTyped(match ...GroupPolicy) GroupPolicy {
	if len(match) > 0 {
		return typedFrom[GroupPolicy](e.Match(asMap(match[0])))
	}
	return typedFrom[GroupPolicy](e.Match())
}
...
func (e *GroupPolicyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GroupPolicyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GroupPolicyLoadMatch and returns an GroupPolicy. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GroupPolicyEntity) LoadTyped(reqmatch GroupPolicyLoadMatch, ctrl map[string]any) (GroupPolicy, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GroupPolicy{}, err
	}
	return typedFrom[GroupPolicy](res), nil
}




func (e *GroupPolicyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// GroupPolicyListMatch and returns []GroupPolicy. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GroupPolicyEntity) ListTyped(reqmatch GroupPolicyListMatch, ctrl map[string]any) ([]GroupPolicy, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GroupPolicy](res), nil
}



func (e *GroupPolicyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GroupPolicyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GroupPolicyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GroupPolicyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
