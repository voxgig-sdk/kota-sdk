...
type EligibilityCheckEntity struct {
	name    string
	client  *core.KotaSDK
...
func NewEligibilityCheckEntity(client *core.KotaSDK, entopts map[string]any) *EligibilityCheckEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EligibilityCheckEntity) GetName() string { return e.name }
...
func (e *EligibilityCheckEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EligibilityCheckEntity) Deleted() bool {
	return e.deleted
}


func (e *EligibilityCheckEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEligibilityCheckEntity(e.client, opts)
}

func (e *EligibilityCheckEntity) Data(args ...any) any {
...
func (e *EligibilityCheckEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EligibilityCheck; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EligibilityCheckEntity) DataTyped(data ...EligibilityCheck) EligibilityCheck {
	if len(data) > 0 {
		return typedFrom[EligibilityCheck](e.Data(asMap(data[0])))
	}
	return typedFrom[EligibilityCheck](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EligibilityCheck (all fields
// optional at the wire level).
func (e *EligibilityCheckEntity) MatchTyped(match ...EligibilityCheck) EligibilityCheck {
	if len(match) > 0 {
		return typedFrom[EligibilityCheck](e.Match(asMap(match[0])))
	}
	return typedFrom[EligibilityCheck](e.Match())
}
...
func (e *EligibilityCheckEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EligibilityCheckEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EligibilityCheckEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EligibilityCheckEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EligibilityCheckCreateData and returns an EligibilityCheck. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EligibilityCheckEntity) CreateTyped(reqdata EligibilityCheckCreateData, ctrl map[string]any) (EligibilityCheck, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return EligibilityCheck{}, err
	}
	return typedFrom[EligibilityCheck](res), nil
}



func (e *EligibilityCheckEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EligibilityCheckEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EligibilityCheckEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
