...
func NewProviderEntity(client *core.KotaSDK, entopts map[string]any) *ProviderEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProviderEntity) GetName() string { return e.name }
...
func (e *ProviderEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProviderEntity) Deleted() bool {
	return e.deleted
}


func (e *ProviderEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProviderEntity(e.client, opts)
}

func (e *ProviderEntity) Data(args ...any) any {
...
func (e *ProviderEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Provider; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProviderEntity) DataTyped(data ...Provider) Provider {
	if len(data) > 0 {
		return typedFrom[Provider](e.Data(asMap(data[0])))
	}
	return typedFrom[Provider](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Provider (all fields
// optional at the wire level).
func (e *ProviderEntity) MatchTyped(match ...Provider) Provider {
	if len(match) > 0 {
		return typedFrom[Provider](e.Match(asMap(match[0])))
	}
	return typedFrom[Provider](e.Match())
}
...
func (e *ProviderEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProviderEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProviderLoadMatch and returns an Provider. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ProviderEntity) LoadTyped(reqmatch ProviderLoadMatch, ctrl map[string]any) (Provider, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Provider{}, err
	}
	return typedFrom[Provider](res), nil
}




func (e *ProviderEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ProviderListMatch and returns []Provider. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ProviderEntity) ListTyped(reqmatch ProviderListMatch, ctrl map[string]any) ([]Provider, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Provider](res), nil
}



func (e *ProviderEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProviderEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProviderEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProviderEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
