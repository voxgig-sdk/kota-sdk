...
const testSeed = `map[string]any{"entity": map[string]any{"associated_person": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "associated_person_eligibility_response_paged_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "contribution_report": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "contribution_report_employee_breakdown": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "contribution_report_employee_breakdown_response_paged_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "create_hosted_session_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "create_session_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dependent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dependents_management_intent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "eligibility_check": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "employee": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "employee_health_insurance_offer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "employee_health_insurance_offer_response_paged_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "employee_health_insurance_policy": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "employee_health_insurance_policy_response_paged_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "employer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "employer_health_insurance_policy": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "employer_health_insurance_policy_response_paged_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "employer_health_insurance_quote": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "employer_health_insurance_quote_response_paged_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "enrolment_intent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "enrolment_intent_requirement_response_paged_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "group": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "group_employee": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "group_employee_response_paged_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "group_policy": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "group_policy_intent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "group_policy_intent_requirement_response_paged_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "group_quote": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "group_quote_intent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "group_quote_intent_requirement_response_paged_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "plan": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "policy": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "policy_amendment_intent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "policy_import_intent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "provider": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "replay": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook_endpoint": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook_endpoint_response_paged_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
